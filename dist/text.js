...
var types = require('components/text/types');
...
var getColor = css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"
...
//   margin-top: 0;
// `
var subTextStyling = css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin-bottom: 0;\n\n  & + * {\n    margin-top: 0;\n  }\n"], ["\n  margin-bottom: 0;\n\n  & + * {\n    margin-top: 0;\n  }\n"])));
...
const XXS = styled(Paragraph)`
  font-size: ${FONT_SIZES.XXS};
`;

const XS = styled(Paragraph)`
  font-size: ${FONT_SIZES.XS};
`;

const MD = styled(Paragraph)`
  font-size: ${FONT_SIZES.MD};
`;

const LG = styled(Paragraph)`
  font-size: ${FONT_SIZES.LG};
`;

const XL = styled(Paragraph)`
  font-size: ${FONT_SIZES.XL};
`;
...
const Hint = styled(XS).attrs(({ color, danger, theme }) => {
    const getTextColor = () => {
