...
var getDisplay = function (_a) {
    var compact = _a.compact, hidden = _a.hidden;
    if (hidden)
        return "none";
...
var responsiveStyles$1 = function (_a) {
    ...
    return (responsivePropsList === null || responsivePropsList === void 0 ? void 0 : responsivePropsList.map(function (_a) {
        ...
        var props = __assign$2(__assign$2({}, originalProps), rProps);
        var alignItems = props.alignItems, justify = props.justify, compactAxis = props.compactAxis, fluid = props.fluid;
...
var FlexBlock = styled.div.attrs(function (_a) {
    ...
    // @ts-ignore
])), getDisplay, function (p) { return p.justify || "initial"; }, function (_a) {
...
}, getFlexDirection$1, function (_a) {
    var fluid = _a.fluid;
    return fluid ? 1 : "unset";
}, getSpacing, responsiveStyles$1);
// @ts-ignore
...
var PaddedFlexBlock = styled(FlexBlock).attrs(function (props) { return ({}); })(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  padding: ", ";\n"], ["\n  padding: ", ";\n"
    // @ts-ignore
])), SPACINGS.SM);
// @ts-ignore
...
exports.AsyncLoadable = function (_a) {
    var _b;
    var children = _a.children, className = _a.className;
    var theme = React.useContext(ThemeContext);
    var isLoading = (_b = __read$2(React.useState(false), 2), _b[0]), setLoadingState = _b[1];
    var withLoading = function (f) { return __awaiter(void 0, void 0, void 0, function () {
        var val;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, returnAfterMinimum(500, f)];
                case 2:
                    val = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    if (isLoading) {
        return jsxRuntime.exports.jsx(Container$2, __assign$2({ justify: "center", className: className, alignItems: "center" }, { children: jsxRuntime.exports.jsx(dist$1.Dots, { color: theme.styles.colorPrimary, size: FONT_SIZES.XXL, delayMS: 100, velocity: -.25 }) }));
    }
    return children({ withLoading: withLoading });
};
exports.AsyncLoadable = styled(exports.AsyncLoadable)(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject([""], [""])));
var Container$2 = styled(FlexBlock)(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n  min-width: 200px;\n  min-height: 200px;\n"], ["\n  height: 100%;\n  width: 100%;\n  min-width: 200px;\n  min-height: 200px;\n"])));
...
var LoaderContainer = styled(FlexBox)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n  position: absolute;\n"], ["\n  height: 100%;\n  width: 100%;\n  position: absolute;\n"])));
...
exports.Loadable = function (_a) {
    ...
    return jsxRuntime.exports.jsxs(Container$1, __assign$2({ justifyContent: "center", gap: "unset", alignItems: "center" }, { children: [jsxRuntime.exports.jsx(ChildrenContainer, __assign$2({ gap: "unset", className: className, opaqueSpinner: opaqueSpinner, showSpinner: showingSpinner, withRows: true }, { children: children })), showingSpinner
                ? jsxRuntime.exports.jsx(LoaderContainer, __assign$2({ justifyContent: "center", alignItems: "center", showSpinner: showingSpinner }, { children: jsxRuntime.exports.jsx(dist$1.Dots, { color: theme.styles.colorPrimary, size: FONT_SIZES.XXL, delayMS: 100, velocity: -.25 }) }))
                : null] }));
};
exports.Loadable = styled(exports.Loadable)(templateObject_4 || (templateObject_4 = __makeTemplateObject([""], [""])));
...
var storesContext;
var useStores = function () {
    return React.useContext(storesContext);
};

var Container = styled(FlexBlock)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background: ", "B3;\n  position: fixed;\n  top: 0;\n  left: 0;\n  height: 100%;\n  width: 100%;\n"], ["\n  background: ", "B3;\n  position: fixed;\n  top: 0;\n  left: 0;\n  height: 100%;\n  width: 100%;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.styles.pageBackground;
});
var Loader = function (_a) {
    var forceVisibility = _a.forceVisibility, delay = _a.delay;
    var ui = useStores().ui;
    var theme = React.useContext(ThemeContext);
    return useObserver(function () {
        ...
        return (jsxRuntime.exports.jsx(Container, __assign$2({ justify: "center", alignItems: "center" }, { children: jsxRuntime.exports.jsx(dist$1.Dots, { "data-component-name": "".concat(Loader.COMPONENT_NAME), color: theme.styles.colorPrimary, size: FONT_SIZES.XXL, delayMS: delay, velocity: -.25 }) })));
    });
};
Loader.defaultProps = {
