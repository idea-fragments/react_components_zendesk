...
var isArray=function(o){return o instanceof Array;};var COMPONENT_NAME$2="Icon";var Icon=function(_a){var color=_a.color,_b=_a.size,size=_b===void 0?1:_b,svg=_a.svg,title=_a.title,_c=_a.onClick,onClick=_c===void 0?DO_NOTHING:_c;return isArray(svg)// @ts-ignore
?jsxRuntime.jsx(MIcon.Stack,__assign({onClick:onClick,size:size,title:title,color:color||"currentColor","data-component-name":COMPONENT_NAME$2},{children:svg.map(function(s,i){return jsxRuntime.jsx(MIcon__default["default"],{path:s},i);})})):jsxRuntime.jsx(MIcon__default["default"],{path:svg,// @ts-ignore
onClick:onClick,size:size,title:title,color:color||"currentColor","data-component-name":COMPONENT_NAME$2});};Icon.COMPONENT_NAME=COMPONENT_NAME$2;var XS$2=".5rem";var SM$2="1rem";var MD$2="1.5rem";var LG$1="2rem";var XL$1="2.5rem";var XXL$1="3rem";var XXXL$1="4rem";var XXXXL$1="5rem";var SPACINGS=Object.freeze({XS:XS$2,SM:SM$2,MD:MD$2,LG:LG$1,XL:XL$1,XXL:XXL$1,XXXL:XXXL$1,XXXXL:XXXXL$1});Object.freeze({DOWN:"down",RIGHT:"right"});var getFlexDirection$1=function(_a){var withRows=_a.withRows;return withRows?"column":"row";};var FlexBox=styled__default["default"].div(templateObject_1$a||(templateObject_1$a=__makeTemplateObject(["\n  align-items: ",";\n  display: ",";\n  flex: ",";\n  flex-direction: ",";\n  gap: ",";\n  justify-content: ",";\n  ","\n\n  ","\n"],["\n  align-items: ",";\n  display: ",";\n  flex: ",";\n  flex-direction: ",";\n  gap: ",";\n  justify-content: ",";\n  ","\n\n  ","\n"])),function(_a){var alignItems=_a.alignItems;return alignItems?alignItems:"initial";},function(p){return p.inline?"inline-flex":"flex";},function(_a){var fluid=_a.fluid;return fluid?1:"unset";},getFlexDirection$1,function(p){return p.gap?p.gap:SPACINGS.SM;},function(p){return p.justifyContent||"initial";},function(p){return p.wrap?wrappedStyling:"";},function(p){return p.responsivePropsList?responsiveStyles$1(p):"";});FlexBox.defaultProps={withRows:false};var responsiveStyles$1=function(_a){var responsivePropsList=_a.responsivePropsList,originalProps=__rest(_a,["responsivePropsList"]);return responsivePropsList===null||responsivePropsList===void 0?void 0:responsivePropsList.map(function(_a){var mediaQueryFunc=_a.mediaQueryFunc,rProps=_a.props;var props=__assign(__assign({},originalProps),rProps);var alignItems=props.alignItems,gap=props.gap,inline=props.inline,justifyContent=props.justifyContent,fluid=props.fluid,wrap=props.wrap;return mediaQueryFunc(styled.css(templateObject_2$9||(templateObject_2$9=__makeTemplateObject(["\n      align-items: ",";\n      display: ",";\n      flex: ",";\n      flex-direction: ",";\n      gap: ",";\n      justify-content: ",";\n      ","\n    "],["\n      align-items: ",";\n      display: ",";\n      flex: ",";\n      flex-direction: ",";\n      gap: ",";\n      justify-content: ",";\n      ","\n    "])),alignItems?alignItems:"initial",inline?"inline-flex":"flex",fluid?1:"unset",getFlexDirection$1(props),gap?gap:SPACINGS.SM,justifyContent||"initial",wrap?wrappedStyling:"")).join("");});};var wrappedStyling=styled.css(templateObject_3$7||(templateObject_3$7=__makeTemplateObject(["\n  flex-wrap: wrap;\n"],["\n  flex-wrap: wrap;\n"])));var templateObject_1$a,templateObject_2$9,templateObject_3$7;/**
 * Copyright Zendesk, Inc.
 *
 * Use of this source code is governed under the Apache License, Version 2.0
 * found at http://www.apache.org/licenses/LICENSE-2.0.
...
Button.defaultProps={fluid:false,flat:false,iconPosition:"right",primary:true,disabled:false};var templateObject_1$9,templateObject_2$8,templateObject_3$6,templateObject_4$4,templateObject_5$3,templateObject_6$2,templateObject_7$1;var Header$1=styled__default["default"](Header$1$1).attrs(function(_a){var danger=_a.danger,success=_a.success,warning=_a.warning,theme=_a.theme;// Color is overwritten by a class style from zendesk :(
...
//   margin-top: 0;
// `
])),function(_a){var color=_a.color;return color;});// const subTextStyling = css`
//   margin-top: 0;
// `
...
])),function(_a){var align=_a.align;return align;},function(_a){var fluid=_a.fluid;return fluid?"100%":"unset";},function(_a){var color=_a.color;return color?getColor:"";},function(_a){var hasSubText=_a.hasSubText;return hasSubText?subTextStyling:"";});// @ts-ignore
