...
var useIsomorphicLayoutEffect = canUseDOM() ? React__default.useLayoutEffect : React__default.useEffect;
...
function useAccordion(_ref) {
  ...
  const [expandedState, setExpandedState] = React__default.useState(defaultExpandedSections || sections.slice(0, 1));
  const [disabledState, setDisabledState] = React__default.useState(collapsible ? [] : expandedState);
  const internalExpandedState = getControlledValue(expandedSections, expandedState);
  const toggle = React__default.useCallback(value => {
    const expanded = [];
    const disabled = [];
  ...
  const getTriggerProps = React__default.useCallback(_ref3 => {
    let {
      value,
      role = 'button',
      tabIndex = 0,
  ...
  const getPanelProps = React__default.useCallback(_ref4 => {
    let {
      value,
      role = 'region',
      ...props
...
function mergeSymbolMaps(additionalSymbols) {
  var symbolMap = {};
  symbolMap.symbols = additionalSymbols ? _extends$4({}, defaultSymbolMap.symbols, additionalSymbols.symbols) : _extends$4({}, defaultSymbolMap.symbols);
  return symbolMap;
}
...
const getColor$1 = lodash_memoize(function (hue) {
...
})(["display:block;position:absolute;top:", "px;right:", ";left:", ";flex:1;border-top:", ";border-color:", ";"], props => props.theme.space.base * 3, props => `calc(50% + ${props.theme.space.base * 6}px)`, props => `calc(-50% + ${props.theme.space.base * 6}px)`, props => props.theme.borders.sm, props => getColor$1('neutralHue', 300, props.theme));
...
const sizeStyles$1 = props => {
  ...
  return styled.css(["margin-bottom:", ";margin-", ":", ";width:", ";min-width:", ";height:", ";min-height:", ";line-height:", ";font-size:", ";"], props.isHorizontal && `${props.theme.space.base * 2}px`, props.theme.rtl ? 'left' : 'right', !props.isHorizontal && `${props.theme.space.base * 3}px`, size, size, size, size, getLineHeight(size, fontSize), fontSize);
};
const colorStyles$3 = props => {
  return styled.css(["background:", ";color:", ";"], props.isActive ? getColor$1('neutralHue', 600, props.theme) : getColor$1('neutralHue', 200, props.theme), props.isActive ? props.theme.colors.background : props.theme.colors.foreground);
};
...
const colorStyles$2 = props => {
  ...
  return styled.css(["border-bottom-color:", ";"], isBare ? 'transparent' : getColor$1('neutralHue', 300, theme));
};
const sizeStyles = props => {
  ...
  return styled.css(["grid-template-rows:", "fr;border-bottom-width:", ";border-bottom-style:solid;padding:", "px ", "px ", "px;line-height:", ";font-size:", ";"], isExpanded ? 1 : 0, theme.borderWidths.sm, paddingTop, paddingHorizontal, paddingBottom, getLineHeight(base * 5, theme.fontSizes.md), theme.fontSizes.md);
};
...
})(["display:flex;position:relative;justify-content:center;padding:", ";&::after{position:absolute;border-left:", ";height:100%;content:'';}", ";"], props => `${props.theme.space.base * 5}px ${props.theme.space.base}px`, props => `${props.theme.borders.sm} ${getColor$1('neutralHue', 600, props.theme)}`, props => retrieveComponentStyles(COMPONENT_ID$4, props));
...
const SectionComponent = React__default.forwardRef((props, ref) => React__default__default["default"].createElement(StyledSection, _extends$3({
  ref: ref
}, props)));
...
const HeaderComponent = React__default.forwardRef((props, ref) => {
  ...
  return React__default__default["default"].createElement(HeaderContext.Provider, {
    value: value
  }, React__default__default["default"].createElement(StyledHeader, _extends$3({
    ...
    ...other
  })), children, React__default__default["default"].createElement(StyledRotateIcon, {
    isCompact: isCompact,
    isHovered: isHovered,
    ...
    onMouseOver: composeEventHandlers(onMouseOver, () => setIsHovered(true)),
    onMouseOut: composeEventHandlers(onMouseOut, () => setIsHovered(false))
  }, React__default__default["default"].createElement(SvgChevronDownStroke, null))));
});
...
const LabelComponent$1 = React__default.forwardRef((props, ref) => {
  ...
  return React__default__default["default"].createElement(StyledButton, _extends$3({
    ref: ref,
    isCompact: isCompact,
    isHovered: isHovered,
    isExpanded: isExpanded,
...
const PanelComponent = React__default.forwardRef((_ref, ref) => {
  ...
  const sectionValue = useSectionContext();
  const isExpanded = expandedSections.includes(sectionValue);
  return React__default__default["default"].createElement(StyledPanel, _extends$3({
    ...
    value: sectionValue,
    ...props
  })), React__default__default["default"].createElement(StyledInnerPanel, null, children));
});
...
const AccordionComponent = React__default.forwardRef((_ref, ref) => {
  ...
  const {
    sections,
    sectionChildren
  } = React__default.useMemo(() => React__default.Children.toArray(children).filter(React__default.isValidElement).map((child, index) => React__default__default["default"].createElement(SectionContext.Provider, {
    key: index,
    value: index
  ...
  return React__default__default["default"].createElement(AccordionContext.Provider, {
    value: accordionContextValue
  }, React__default__default["default"].createElement(StyledAccordion, _extends$3({
    ref: ref
...
const StepComponent = React__default.forwardRef((_ref, ref) => {
  ...
  return React__default__default["default"].createElement(StyledStep, _extends$3({
    ref: ref,
    isHorizontal: isHorizontal
  }, props), isHorizontal && React__default__default["default"].createElement(StyledLine, null), children);
});
...
const LabelComponent = React__default.forwardRef((_ref, ref) => {
  ...
  const styledIcon = React__default__default["default"].createElement(StyledIcon, {
    isActive: isActive,
    isHorizontal: isHorizontal
  }, isCompleted ? React__default__default["default"].createElement(SvgCheckSmStroke, iconProps) : stepIcon);
  return React__default__default["default"].createElement(StyledLabel, _extends$3({
    ref: ref,
    isActive: isActive,
    isHorizontal: isHorizontal
  }, other), isHorizontal ? React__default__default["default"].createElement(StyledIconFlexContainer, null, styledIcon) : styledIcon, React__default__default["default"].createElement(StyledLabelText, {
    isHidden: isHidden,
    isHorizontal: isHorizontal
  }, children));
});
...
const ContentComponent$1 = React__default.forwardRef((props, ref) => {
  ...
  return isHorizontal === false ? React__default__default["default"].createElement(StyledContent, _extends$3({
    ref: ref,
    isActive: isActive
  }, props), React__default__default["default"].createElement(StyledInnerContent, {
...
const StepperComponent = React__default.forwardRef((_ref, ref) => {
  ...
  return React__default__default["default"].createElement(StepperContext.Provider, {
    value: stepperContext
  }, React__default__default["default"].createElement(StyledStepper, _extends$3({
    ref: ref,
    isHorizontal: isHorizontal
  }, props), React__default.useMemo(() => React__default.Children.toArray(children).filter(React__default.isValidElement).map((child, index) => React__default__default["default"].createElement(StepContext.Provider, {
    key: index,
    value: {
...
Stepper.Label = Label;
Stepper.Step = Step;
const OppositeContentComponent = React__default.forwardRef((props, ref) => React__default__default["default"].createElement(StyledOppositeContent, _extends$3({
  ref: ref
}, props)));
...
const ItemComponent = React__default.forwardRef((_ref, ref) => {
  ...
  return React__default__default["default"].createElement(TimelineItemContext.Provider, {
    value: value
  }, React__default__default["default"].createElement(StyledTimelineItem, _extends$3({
    ref: ref,
...
var SvgCircleFullStroke = function SvgCircleFullStroke(props) {
  return /*#__PURE__*/React__default__namespace.createElement("svg", _extends({
    ...
    viewBox: "0 0 12 12",
    "aria-hidden": "true"
  }, props), _circle || (_circle = /*#__PURE__*/React__default__namespace.createElement("circle", {
    cx: 6,
    cy: 6,
    r: 4.5,
    fill: "none",
...
const ContentComponent = React__default.forwardRef((props, ref) => {
  ...
  return React__default__default["default"].createElement(React__default__default["default"].Fragment, null, React__default__default["default"].createElement(StyledSeparator, null, React__default__default["default"].createElement(StyledItemIcon, {
    surfaceColor: surfaceColor
  }, icon || React__default__default["default"].createElement(SvgCircleFullStroke, null))), React__default__default["default"].createElement(StyledTimelineContent, _extends$3({
    ref: ref
  }, props)));
});
...
const TimelineComponent = React__default.forwardRef((_ref, ref) => {
  ...
  return React__default__default["default"].createElement(TimelineContext.Provider, {
    value: value
  }, React__default__default["default"].createElement(StyledTimeline, _extends$3({
    ref: ref
  }, props)));
});
...
var getColor = styled.css(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"
