...
root._=_;}}).call(commonjsGlobal);})(lodash,lodash.exports);var DO_NOTHING=function(){};var GlobalAlert=function(_a){var body=_a.body,danger=_a.danger,info=_a.info,notDismissible=_a.notDismissible,noActionButton=_a.noActionButton,showTitle=_a.showTitle,success=_a.success,title=_a.title,buttonText=_a.buttonText,warning=_a.warning,_b=_a.onClose,onClose=_b===void 0?DO_NOTHING:_b;var dismissible=!notDismissible;var hasActionButton=!noActionButton;var type=function(){if(danger)return"error";if(info)return"info";if(success)return"success";if(warning)return"warning";return undefined;};// @ts-ignore
