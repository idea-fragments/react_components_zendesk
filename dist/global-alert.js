 ...
 */var generateUID=function(){var counter=1;var map=new WeakMap();/**
     * @borrows {uid}
     */var uid=function(item,index){if(typeof item==='number'||typeof item==='string'){return index?"idx-"+index:"val-"+item;}if(!map.has(item)){map.set(item,counter++);return uid(item);}return'uid'+map.get(item);};return uid;};var createSource=function(prefix){if(prefix===void 0){prefix='';}return{value:1,prefix:prefix,uid:generateUID()};};var counter=createSource();React__namespace.createContext(createSource());var getId=function(source){return source.value++;};var getPrefix=function(source){return source?source.prefix:'';};// --------------------------------------------
...
root._=_;}}).call(commonjsGlobal);})(lodash,lodash.exports);var DO_NOTHING=function(){};var GlobalAlert=function(_a){var body=_a.body,danger=_a.danger,info=_a.info,notDismissible=_a.notDismissible,noActionButton=_a.noActionButton,_b=_a.showTitle,showTitle=_b===void 0?false:_b,success=_a.success,title=_a.title,buttonText=_a.buttonText,warning=_a.warning,_c=_a.onActionButtonClick,onActionButtonClick=_c===void 0?DO_NOTHING:_c,_d=_a.onClose,onClose=_d===void 0?DO_NOTHING:_d;var dismissible=!notDismissible;var hasActionButton=!noActionButton;var type=function(){if(danger)return"error";if(info)return"info";if(success)return"success";if(warning)return"warning";return undefined;};// @ts-ignore
return jsxRuntime.jsxs(GlobalAlert$1,__assign({type:type()},{children:[jsxRuntime.jsxs(GlobalAlert$1.Content,{children:[showTitle?jsxRuntime.jsx(GlobalAlert$1.Title,{children:title}):null,jsxRuntime.jsx("div",{children:body})]}),hasActionButton?jsxRuntime.jsx(GlobalAlert$1.Button,__assign({onClick:onActionButtonClick},{children:buttonText})):null,dismissible?jsxRuntime.jsx(GlobalAlert$1.Close,{onClick:onClose,"aria-label":"Close Alert"}):null]}));};exports.GlobalAlert=GlobalAlert;
//# sourceMappingURL=global-alert.js.map
