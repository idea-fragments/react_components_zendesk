...
root._=_;}}).call(commonjsGlobal);})(lodash,lodash.exports);var DO_NOTHING=function(){};var GlobalAlert=function(_a){var body=_a.body,danger=_a.danger,info=_a.info,notDismissible=_a.notDismissible,noActionButton=_a.noActionButton,_b=_a.showTitle,showTitle=_b===void 0?false:_b,success=_a.success,title=_a.title,buttonText=_a.buttonText,warning=_a.warning,_c=_a.onClose,onClose=_c===void 0?DO_NOTHING:_c;var dismissible=!notDismissible;var hasActionButton=!noActionButton;var type=function(){if(danger)return"error";if(info)return"info";if(success)return"success";if(warning)return"warning";return undefined;};// @ts-ignore
return jsxRuntime.jsxs(GlobalAlert$1,__assign({type:type()},{children:[jsxRuntime.jsxs(GlobalAlert$1.Content,{children:[showTitle?jsxRuntime.jsx(GlobalAlert$1.Title,{children:title}):null,jsxRuntime.jsx("div",{children:body})]}),hasActionButton?jsxRuntime.jsx(GlobalAlert$1.Button,{children:buttonText}):null,dismissible?jsxRuntime.jsx(GlobalAlert$1.Close,{onClick:onClose,"aria-label":"Close Alert"}):null]}));};exports.GlobalAlert=GlobalAlert;
