...
function mergeSymbolMaps(additionalSymbols){var symbolMap={};symbolMap.symbols=additionalSymbols?_extends$4({},defaultSymbolMap.symbols,additionalSymbols.symbols):_extends$4({},defaultSymbolMap.symbols);return symbolMap;}function exec(operators,values){var _ref;var op=operators.pop();values.push(op.f.apply(op,(_ref=[]).concat.apply(_ref,values.splice(-op.argCount))));return op.precedence;}function calculate(expression,additionalSymbols){var symbolMap=mergeSymbolMaps(additionalSymbols);var match;var operators=[symbolMap.symbols['('].prefix];var values=[];var pattern=new RegExp(// Pattern for numbers
 ...
 * }
 */function darken(amount,color){if(color==='transparent')return color;var hslColor=parseToHsl(color);return toColorString(_extends$4({},hslColor,{lightness:guard(0,1,hslColor.lightness-parseFloat(amount))}));}// prettier-ignore
...
FlexBlock.COMPONENT_NAME=COMPONENT_NAME;FlexBlock.defaultProps={compactAxis:false,compact:false,withRows:false,responsivePropsList:[]};var PaddedFlexBlock=styled__default["default"](FlexBlock).attrs(function(props){return{};})(templateObject_2$2||(templateObject_2$2=__makeTemplateObject(["\n  padding: ",";\n"],["\n  padding: ",";\n"// @ts-ignore
])),SPACINGS.SM);// @ts-ignore
PaddedFlexBlock.COMPONENT_NAME="PaddedFlexBlock";var templateObject_1$2,templateObject_2$2;var getColor=styled.css(templateObject_1$1||(templateObject_1$1=__makeTemplateObject(["\n  color: ",";\n"],["\n  color: ",";\n"// const subTextStyling = css`
//   margin-top: 0;
// `
