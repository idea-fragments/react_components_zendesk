...
Button.defaultProps={fluid:false,flat:false,iconPosition:"right",primary:true,disabled:false};var templateObject_1$1,templateObject_2,templateObject_3,templateObject_4,templateObject_5,templateObject_6,templateObject_7;var ButtonLink=function(_a){var LinkComponent=_a.LinkComponent,external=_a.external,flat=_a.flat,icon=_a.icon,iconPosition=_a.iconPosition,children=_a.children,otherProps=__rest(_a,["LinkComponent","external","flat","icon","iconPosition","children"]);return jsxRuntime.jsx(Button,__assign({},otherProps,{flat:flat!=null?flat:!otherProps.inline,// @ts-ignore
innerAs:LinkComponent},external?{target:"_blank"}:{},{children:icon?jsxRuntime.jsxs(FlexBox,__assign({gap:SPACINGS.XS,justifyContent:"center",alignItems:"center"},{children:[iconPosition==="left"&&jsxRuntime.jsx(Icon,{color:"currentColor",svg:icon}),children?jsxRuntime.jsx("span",{children:children}):undefined,iconPosition==="right"&&jsxRuntime.jsx(Icon,{color:"currentColor",svg:icon})]})):jsxRuntime.jsx("span",{children:children})}));};ButtonLink.COMPONENT_NAME="ButtonLink";ButtonLink.defaultProps={primary:false,onClick:DO_NOTHING,LinkComponent:"a",external:false,iconPosition:"left"};var InlineButtonLink=styled__default["default"](function(props){return jsxRuntime.jsx(ButtonLink,__assign({inline:true},props));})(templateObject_1||(templateObject_1=__makeTemplateObject(["\n  text-decoration: none;\n"],["\n  text-decoration: none;\n"])));var templateObject_1;exports.Breadcrumbs=Breadcrumbs;exports.ButtonLink=ButtonLink;exports.InlineButtonLink=InlineButtonLink;
