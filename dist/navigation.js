...
PaddedFlexBlock.COMPONENT_NAME="PaddedFlexBlock";var templateObject_1$6,templateObject_2$4;var useTheme=function(){return React.useContext(styled.ThemeContext);};// export const setThemeContext = (ctx :)
var XXS=".8rem";var XS=".9rem";var SM="1rem";var MD="1.3rem";var LG="1.7rem";var XL="2.3rem";var XXL="3.3rem";// h1
var XXXL="4rem";var XXXXL="5rem";var XXXXXL="6rem";var THIN="100";var LIGHT="300";var REGULAR="400";var MEDIUM="500";var BOLD="700";var BLACK="800";var FONT_SIZES={XXS:XXS,XS:XS,SM:SM,MD:MD,LG:LG,XL:XL,XXL:XXL,XXXL:XXXL,XXXXL:XXXXL,XXXXXL:XXXXXL};Object.freeze({XXS:XXS.replace("r",""),XS:XS.replace("r",""),SM:SM.replace("r",""),MD:MD.replace("r",""),LG:LG.replace("r",""),XL:XL.replace("r",""),XXL:XXL.replace("r",""),XXXL:XXXL.replace("r",""),XXXXL:XXXXL.replace("r",""),XXXXXL:XXXXXL.replace("r","")});var FONT_WEIGHTS={THIN:THIN,LIGHT:LIGHT,REGULAR:REGULAR,MEDIUM:MEDIUM,BOLD:BOLD,BLACK:BLACK};var Breadcrumbs=function(_a){var children=_a.children;var theme=useTheme();var numChildren=React.Children.count(children);var isNotLastChild=function(index){return index!==numChildren-1;};var separator=jsxRuntime.jsx(Icon,{svg:"arrow-ios-forward-outline",color:theme.styles.colors.orange["400"]});return jsxRuntime.jsx(Container,{children:React.Children.map(children,function(c,i){return isNotLastChild(i)?jsxRuntime.jsxs(React.Fragment,{children:[c,separator]}):jsxRuntime.jsx("span",{children:c});})});};var Container=styled__default["default"](FlexBlock)(templateObject_1$5||(templateObject_1$5=__makeTemplateObject(["\n  margin-top: ",";\n  align-items: center;\n\n  color: ",";\n  font-weight: "," !important;\n\n  & > *:last-child {\n    margin-top: -0.15em;\n    font-size: ",";\n  }\n"],["\n  margin-top: ",";\n  align-items: center;\n\n  color: ",";\n  font-weight: "," !important;\n\n  & > *:last-child {\n    margin-top: -0.15em;\n    font-size: ",";\n  }\n"])),SPACINGS.SM,function(_a){var theme=_a.theme;return theme.styles.colors.orange["400"];},FONT_WEIGHTS.REGULAR,FONT_SIZES.MD);var templateObject_1$5;var propTypes={exports:{}};var reactIs={exports:{}};var reactIs_production_min={};/** @license React v16.13.1
