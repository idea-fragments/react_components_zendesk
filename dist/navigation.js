Object.defineProperty(exports,'__esModule',{value:true});var jsxRuntime=require('react/jsx-runtime');var MIcon=require('@mdi/react');var styled=require('styled-components');var React=require('react');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e};}function _interopNamespace(e){if(e&&e.__esModule)return e;var n=Object.create(null);if(e){Object.keys(e).forEach(function(k){if(k!=='default'){var d=Object.getOwnPropertyDescriptor(e,k);Object.defineProperty(n,k,d.get?d:{enumerable:true,get:function(){return e[k];}});}});}n["default"]=e;return Object.freeze(n);}var MIcon__default=/*#__PURE__*/_interopDefaultLegacy(MIcon);var styled__default=/*#__PURE__*/_interopDefaultLegacy(styled);var React__default=/*#__PURE__*/_interopDefaultLegacy(React);var React__namespace=/*#__PURE__*/_interopNamespace(React);/******************************************************************************
...
var isArray=function(o){return o instanceof Array;};var isString=function(o){return typeof o==="string";};var COMPONENT_NAME$1="Icon";var Icon=function(_a){var color=_a.color,_b=_a.size,size=_b===void 0?1:_b,SVG=_a.svg,title=_a.title,_c=_a.onClick,onClick=_c===void 0?DO_NOTHING:_c;return isArray(SVG)// @ts-ignore
?jsxRuntime.jsx(MIcon.Stack,__assign({onClick:onClick,size:size,title:title,color:color||"currentColor","data-component-name":COMPONENT_NAME$1},{children:SVG.map(function(s,i){return jsxRuntime.jsx(MIcon__default["default"],{path:s},i);})})):isString(SVG)?jsxRuntime.jsx(MIcon__default["default"],{path:SVG,// @ts-ignore
onClick:onClick,size:size,title:title,color:color||"currentColor","data-component-name":COMPONENT_NAME$1})// @ts-ignore
:jsxRuntime.jsx(SVG,{fill:color||"currentColor","data-component-name":COMPONENT_NAME$1,height:size,onClick:onClick,width:size,title:title});};Icon.COMPONENT_NAME=COMPONENT_NAME$1;var XS$1=".5rem";var SM$1="1rem";var MD$1="1.5rem";var LG$1="2rem";var XL$1="2.5rem";var XXL$1="3rem";var XXXL$1="4rem";var XXXXL$1="5rem";var SPACINGS=Object.freeze({XS:XS$1,SM:SM$1,MD:MD$1,LG:LG$1,XL:XL$1,XXL:XXL$1,XXXL:XXXL$1,XXXXL:XXXXL$1});Object.freeze({DOWN:"down",RIGHT:"right"});var COMPONENT_NAME="FlexBlock";var getFlexDirection$1=function(_a){var withRows=_a.withRows;return withRows?"column":"row";};var getSpacingDirection=function(direction){return direction==="column"?"margin-bottom":"margin-right";};var getDisplay=function(_a){var compact=_a.compact,hidden=_a.hidden;if(hidden)return"none";return compact?"inline-flex":"flex";};var getSpacing=function(_a){var spacing=_a.spacing,props=__rest(_a,["spacing"]);if(!spacing)return"";return"& > *:not(:last-child) {\n      margin: 0;\n      ".concat(getSpacingDirection(getFlexDirection$1(props)),": ").concat(spacing,";\n    }");};var responsiveStyles$1=function(_a){var responsivePropsList=_a.responsivePropsList,originalProps=__rest(_a,["responsivePropsList"]);return responsivePropsList===null||responsivePropsList===void 0?void 0:responsivePropsList.map(function(_a){var mediaQueryFunc=_a.mediaQueryFunc,rProps=_a.props;var props=__assign(__assign({},originalProps),rProps);var alignItems=props.alignItems,justify=props.justify,compactAxis=props.compactAxis,fluid=props.fluid;return mediaQueryFunc("\n              display: ".concat(getDisplay(props),";\n              justify-content: ").concat(justify||"initial",";\n              align-items: ").concat(alignItems?alignItems:"initial","; \n              // align-self: ").concat(compactAxis?"initial":"stretch",";\n              flex-direction: ").concat(getFlexDirection$1(props),";\n              flex: ").concat(fluid?1:"unset",";\n              ").concat(getSpacing(props),"\n          ")).join("");});};var FlexBlock=styled__default["default"].div.attrs(function(_a){var spacing=_a.spacing;return{spacing:spacing===undefined?SPACINGS.SM:spacing};})(templateObject_1$6||(templateObject_1$6=__makeTemplateObject(["\n  display: ",";\n  justify-content: ",";\n  align-items: ",";\n    // align-self: ",";\n  flex-direction: ",";\n  flex: ",";\n  ","\n\n  ","\n"],["\n  display: ",";\n  justify-content: ",";\n  align-items: ",";\n    // align-self: ",";\n  flex-direction: ",";\n  flex: ",";\n  ","\n\n  ","\n"// @ts-ignore
])),getDisplay,function(p){return p.justify||"initial";},function(_a){var alignItems=_a.alignItems;return alignItems?alignItems:"initial";},function(_a){var compactAxis=_a.compactAxis;return compactAxis?"initial":"stretch";},getFlexDirection$1,function(_a){var fluid=_a.fluid;return fluid?1:"unset";},getSpacing,responsiveStyles$1);// @ts-ignore
...
return newColor;};var lighter=function(c){return light(c,0.25);};var lightness=function(c,amount){if(amount===void 0){amount=95;}return color(c).lightness(amount).hex();};var lightnessDelta=function(c,delta){var currentColor=color(c);var currentLightness=currentColor.lightness();var newLightness=currentLightness+delta;var isTooBlackOrWhite=newLightness===0||newLightness===100;if(isTooBlackOrWhite)newLightness=currentLightness+delta/2;return currentColor.lightness(newLightness).hex();};var dark=function(c,amount){if(amount===void 0){amount=0.2;}return color(c).darken(amount).hex();};var darker=function(c){return dark(c,0.3);};var XXS=".8rem";var XS=".9rem";var SM="1rem";var MD="1.3rem";var LG="1.7rem";var XL="2.3rem";var XXL="3.3rem";// h1
var XXXL="4rem";var XXXXL="5rem";var XXXXXL="6rem";var THIN="100";var LIGHT="300";var REGULAR="400";var MEDIUM="500";var BOLD="700";var BLACK="800";var FONT_SIZES={XXS:XXS,XS:XS,SM:SM,MD:MD,LG:LG,XL:XL,XXL:XXL,XXXL:XXXL,XXXXL:XXXXL,XXXXXL:XXXXXL};Object.freeze({XXS:XXS.replace("r",""),XS:XS.replace("r",""),SM:SM.replace("r",""),MD:MD.replace("r",""),LG:LG.replace("r",""),XL:XL.replace("r",""),XXL:XXL.replace("r",""),XXXL:XXXL.replace("r",""),XXXXL:XXXXL.replace("r",""),XXXXXL:XXXXXL.replace("r","")});var FONT_WEIGHTS={THIN:THIN,LIGHT:LIGHT,REGULAR:REGULAR,MEDIUM:MEDIUM,BOLD:BOLD,BLACK:BLACK};var Breadcrumbs=function(_a){var children=_a.children;var numChildren=React.Children.count(children);var isNotLastChild=function(index){return index!==numChildren-1;};var separator=jsxRuntime.jsx(Icon,{svg:"arrow-ios-forward-outline",color:COLORS.HUB_SPOT_ORANGE});return jsxRuntime.jsx(Container,{children:React.Children.map(children,function(c,i){return isNotLastChild(i)?jsxRuntime.jsxs(React.Fragment,{children:[c,separator]}):jsxRuntime.jsx("span",{children:c});})});};var Container=styled__default["default"](FlexBlock)(templateObject_1$5||(templateObject_1$5=__makeTemplateObject(["\n  margin-top: ",";\n  align-items: center;\n\n  color: ",";\n  font-weight: "," !important;\n\n  & > *:last-child {\n    margin-top: -.15em;\n    font-size: ",";\n  }\n"],["\n  margin-top: ",";\n  align-items: center;\n\n  color: ",";\n  font-weight: "," !important;\n\n  & > *:last-child {\n    margin-top: -.15em;\n    font-size: ",";\n  }\n"])),SPACINGS.SM,COLORS.HUB_SPOT_ORANGE,FONT_WEIGHTS.REGULAR,FONT_SIZES.MD);var templateObject_1$5;var propTypes={exports:{}};var reactIs={exports:{}};var reactIs_production_min={};/** @license React v16.13.1
...
Button.defaultProps={fluid:false,flat:false,iconPosition:"left",primary:true,disabled:false};var LoaderContainer=styled__default["default"](FlexBox)(templateObject_9||(templateObject_9=__makeTemplateObject(["\n  min-height: 30px;\n"],["\n  min-height: 30px;\n"])));var templateObject_1$1,templateObject_2,templateObject_3,templateObject_4,templateObject_5,templateObject_6,templateObject_7,templateObject_8,templateObject_9;var ButtonLink=React.forwardRef(function(_a,ref){var LinkComponent=_a.LinkComponent,external=_a.external,flat=_a.flat,otherProps=__rest(_a,["LinkComponent","external","flat"]);return jsxRuntime.jsx(Button,__assign({ref:ref},otherProps,{flat:flat!=null?flat:!otherProps.inline,// @ts-ignore
innerAs:LinkComponent},external?{target:"_blank"}:{}));});ButtonLink.defaultProps={primary:false,onClick:DO_NOTHING,LinkComponent:"a",external:false,iconPosition:"left"};var InlineButtonLink=styled__default["default"](function(props){return jsxRuntime.jsx(ButtonLink,__assign({inline:true},props));})(templateObject_1||(templateObject_1=__makeTemplateObject(["\n  text-decoration: none;\n"],["\n  text-decoration: none;\n"])));var templateObject_1;exports.Breadcrumbs=Breadcrumbs;exports.ButtonLink=ButtonLink;exports.InlineButtonLink=InlineButtonLink;
