...
Icon.COMPONENT_NAME = COMPONENT_NAME$1
var XS$1 = ".5rem"
var SM$1 = "1rem"
var MD$1 = "1.5rem"
var LG$1 = "2rem"
...
var getSpacing = function (_a) {
  ...
  return "& > *:not(:last-child) {\n      margin: 0;\n      "
    .concat(getSpacingDirection(getFlexDirection$1(props)), ": ")
    .concat(spacing, ";\n    }")
}
    ...
    : responsivePropsList.map(function (_a) {
        ...
        return mediaQueryFunc(
          "\n              display: "
            ...
            .concat(getFlexDirection$1(props), ";\n              flex: ")
...
var Breadcrumbs = function (_a) {
  ...
  var isNotLastChild = function (index) {
    return index !== numChildren - 1
  }
  var separator = jsxRuntime.jsx(Icon, {
    svg: "arrow-ios-forward-outline",
    color: COLORS.HUB_SPOT_ORANGE,
  })
  return jsxRuntime.jsx(Container, {
    children: React.Children.map(children, function (c, i) {
      return isNotLastChild(i)
        ? jsxRuntime.jsxs(React.Fragment, { children: [c, separator] })
        : jsxRuntime.jsx("span", { children: c })
    }),
  })
}
var Container = styled__default["default"](FlexBlock)(
  templateObject_1$5 ||
...
const StyledProgressBackground = styled__default["default"].div
  ...
  (props) => getColor("neutralHue", 200, props.theme),
  (props) => props.color || getColor("successHue", 600, props.theme),
...
const retrieveSkeletonBackgroundColor = (_ref) => {
  ...
  return styled.css(
    ["background-color:", ";"],
    getColor("neutralHue", 800, theme, 0.1),
  )
}
...
const retrieveSkeletonGradient = (_ref3) => {
  ...
  return styled.css(
    ...
    isLight
      ? getColor("chromeHue", 700, theme, 0.4)
...
var templateObject_1$1,
  ...
  templateObject_9,
  templateObject_10
var ButtonLink = React.forwardRef(function (_a, ref) {
  var LinkComponent = _a.LinkComponent,
    external = _a.external,
    flat = _a.flat,
    otherProps = __rest(_a, ["LinkComponent", "external", "flat"])
  return jsxRuntime.jsx(
    Button,
    __assign(
      { ref: ref },
      otherProps,
      {
        flat: flat != null ? flat : !otherProps.inline, // @ts-ignore
...
var InlineButtonLink = styled__default["default"](function (props) {
  return jsxRuntime.jsx(ButtonLink, __assign({ inline: true }, props))
})(
  templateObject_1 ||
...
exports.InlineButtonLink = InlineButtonLink
