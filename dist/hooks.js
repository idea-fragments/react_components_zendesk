...
const Dots$1 = React.forwardRef((_ref, ref) => {
  ...
  const { delayComplete } = useSchedule({
    duration,
    delayMS,
    loop: true,
  })
...
const Spinner = React.forwardRef((_ref, ref) => {
  ...
  const { elapsed, delayComplete } = useSchedule({
    duration,
    delayMS,
  })
...
TranslucentLoader = styled__default["default"](TranslucentLoader)(
...
var SpinnerContainer = styled__default["default"](FlexBox)(
  templateObject_3 ||
...
var breakpointQueries = function (_a) {
  ...
  return (
    (_b = {}),
    (_b[phone] = "(max-width: ".concat(unit(phoneSize), ")")),
    (_b[tablet] = "(min-width: "
      .concat(unit(phoneSize + 1), ") and (max-width: ")
      .concat(unit(tabletSize), ")")),
    (_b[largeTablet] = "(min-width: "
      .concat(unit(tabletSize + 1), ") and (max-width: ")
      .concat(unit(largeTabletSize), ")")),
    (_b[smallComputer] = "(min-width: "
      .concat(unit(largeTabletSize + 1), ") and (max-width: ")
      .concat(unit(smallComputerSize), ")")),
    (_b[largeComputer] = "(min-width: ".concat(
      unit(smallComputerSize + 1),
      ")",
    )),
    _b
  )
...
var useDeviceSizeWatcher = function () {
  ...
  var deviceMediaQueryLists = React.useMemo(
    function () {
      return Object.values(DEVICES).reduce(function (map, size) {
        var _a
        return __assign(
          __assign({}, map),
          ((_a = {}), (_a[size] = window.matchMedia(queries[size])), _a),
        )
      }, {})
    },
    [queries],
  )
  var initChangeWatchers = React.useCallback(
    function () {
  ...
  var removeChangeWatchers = React.useCallback(
    function () {
      Object.entries(deviceMediaQueryLists).forEach(function (_a) {
        var _b = __read(_a, 2),
          size = _b[0],
  ...
  var setInitialSize = React.useCallback(
    function () {
      Object.entries(deviceMediaQueryLists).forEach(function (_a) {
        var _b = __read(_a, 2),
          size = _b[0],
