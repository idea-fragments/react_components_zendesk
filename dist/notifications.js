...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    return React__default["default"].createElement('style', _extends({}, props, { dangerouslySetInnerHTML: { __html: css() } }));
  };
};
...
process.env.NODE_ENV !== "production" ? StyleSheetManager.propTypes = {
  sheet: propTypesExports.oneOfType([propTypesExports.instanceOf(StyleSheet), propTypesExports.instanceOf(ServerStyleSheet)]),

  target: propTypesExports.shape({
    appendChild: propTypesExports.func.isRequired
  })
} : void 0;
...
function createStyledComponent(target, options, rules) {
  ...
  var forwardRef = function forwardRef(props, ref) {
    return React__default["default"].createElement(ParentComponent, _extends({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
  };
  ...
  var WithTheme = React__default["default"].forwardRef(function (props, ref) {
    return React__default["default"].createElement(
      ...
      function (theme) {
        ...
        return React__default["default"].createElement(Component$$1, _extends({}, props, { theme: themeProp, ref: ref }));
      }
    );
  });
...
var FlexBox = styled.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  align-items: ", ";\n  display: ", ";\n  flex: ", ";\n  flex-direction: ", ";\n  gap: ", ";\n  justify-content: ", ";\n  ", "\n\n  ", "\n"], ["\n  align-items: ", ";\n  display: ", ";\n  flex: ", ";\n  flex-direction: ", ";\n  gap: ", ";\n  justify-content: ", ";\n  ", "\n\n  ", "\n"])), function (_a) {
...
var Icon = function (_a) {
    ...
    return isArray(svg)
        // @ts-ignore
        ? jsxRuntime.exports.jsx(Icon$1.Stack, __assign({ onClick: onClick, size: size, title: title, color: color || "currentColor", "data-component-name": COMPONENT_NAME }, { children: svg.map(function (s, i) { return jsxRuntime.exports.jsx(Icon$1, { path: s }, i); }) }))
        : jsxRuntime.exports.jsx(Icon$1, { path: svg, 
            // @ts-ignore
            onClick: onClick, size: size, title: title, color: color || "currentColor", "data-component-name": COMPONENT_NAME });
};
...
var INFO = INFO_PANEL_TYPES.INFO, DANGER = INFO_PANEL_TYPES.DANGER, SUCCESS = INFO_PANEL_TYPES.SUCCESS, WARNING = INFO_PANEL_TYPES.WARNING;
exports.InfoPanel = function (_a) {
    var children = _a.children, className = _a.className, iconVerticalAlignment = _a.iconVerticalAlignment, type = _a.type;
    var alignItems = iconVerticalAlignment === "center"
        ? "center" : undefined;
    var theme = useTheme();
    ...
    return jsxRuntime.exports.jsxs(Container, __assign({ alignItems: alignItems, className: className, color: foreground, bgColor: background }, { children: [jsxRuntime.exports.jsx("div", { children: jsxRuntime.exports.jsx(Icon, { svg: mdiInformation, color: iconColor }) }), jsxRuntime.exports.jsx("div", __assign({ css: "flex: 1;" }, { children: children }))] }));
};
exports.InfoPanel = styled(exports.InfoPanel)(templateObject_1 || (templateObject_1 = __makeTemplateObject([""], [""])));
exports.InfoPanel.defaultProps = {
    type: INFO_PANEL_TYPES.INFO,
};
var Container = styled(FlexBox)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: ", ";\n  color: ", ";\n  border-radius: 1rem;\n  padding: 1.5rem;\n"], ["\n  background: ", ";\n  color: ", ";\n  border-radius: 1rem;\n  padding: 1.5rem;\n"])), function (_a) {
...
var bgColor = function (type, theme) {
    if (type === DANGER)
        return theme.styles.colorDanger;
    if (type === WARNING)
        return theme.styles.colorWarning;
    if (type === SUCCESS)
        return theme.styles.colorSuccess;
...
var require$$1 = /*@__PURE__*/getAugmentedNamespace(styledComponents_esm);
...
function requireDist () {
	...
	(function (exports) {
		...
		module.exports = requirePropTypes();
...
(function (exports) {
	...
	module.exports = requireClassnames();
...
var Notification = function (_a) {
    var body = _a.body, danger = _a.danger, info = _a.info, notDismissible = _a.notDismissible, success = _a.success, title = _a.title, warning = _a.warning, _b = _a.onClose, onClose = _b === void 0 ? DO_NOTHING : _b;
    ...
    return jsxRuntime.exports.jsxs(dist$1.Notification, __assign({ type: type() }, { children: [jsxRuntime.exports.jsx(dist$1.Title, { children: title }), jsxRuntime.exports.jsx("div", { children: body }), dismissible
                ? jsxRuntime.exports.jsx(dist$1.Close, { onClick: onClose, "aria-label": "Close Notification" })
                : null] }));
};
