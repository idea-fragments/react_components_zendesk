...
ORANGE:"#ff9369",HUB_SPOT_ORANGE:"rgb(255, 122, 89)",MIDNIGHT_BLACK:"#1d1e21",BLACK:"#1f1f1f",WHITE:"#ffffff",GREY_NOT_QUITE_BLUE:"#b0b7bd",GREY:"#919292",VERY_LIGHT_GREY:"#F7F7F7",LIGHT_GREY:"#dddddd",TRANSPARENT:"#00000000"};Object.freeze(COLORS);var useTheme=function(){return React.useContext(styled.ThemeContext);};// export const setThemeContext = (ctx :)
var INFO_PANEL_TYPES={INFO:0,SUCCESS:1,WARNING:2,DANGER:3};var INFO=INFO_PANEL_TYPES.INFO,DANGER=INFO_PANEL_TYPES.DANGER,SUCCESS=INFO_PANEL_TYPES.SUCCESS,WARNING=INFO_PANEL_TYPES.WARNING;exports.InfoPanel=function(_a){var children=_a.children,className=_a.className,iconVerticalAlignment=_a.iconVerticalAlignment,type=_a.type;var alignItems=iconVerticalAlignment==="center"?"center":undefined;var theme=useTheme();var background=bgColor(type,theme);var foreground=theme.styles.getTextColorForBackground({color:background,theme:theme});var iconColor=type===INFO?COLORS.LIGHT_BLUE:foreground;return jsxRuntime.jsxs(Container,__assign({alignItems:alignItems,className:className,color:foreground,bgColor:background},{children:[jsxRuntime.jsx("div",{children:jsxRuntime.jsx(Icon,{svg:js.mdiInformation,color:iconColor})}),jsxRuntime.jsx("div",__assign({css:"flex: 1;"},{children:children}))]}));};exports.InfoPanel=styled__default["default"](exports.InfoPanel)(templateObject_1$1||(templateObject_1$1=__makeTemplateObject([""],[""])));exports.InfoPanel.defaultProps={type:INFO_PANEL_TYPES.INFO};var Container=styled__default["default"](FlexBox)(templateObject_2||(templateObject_2=__makeTemplateObject(["\n  background: ",";\n  color: ",";\n  border-radius: 1rem;\n  padding: 1.5rem;\n"],["\n  background: ",";\n  color: ",";\n  border-radius: 1rem;\n  padding: 1.5rem;\n"])),function(_a){var bgColor=_a.bgColor;return bgColor;},function(_a){var color=_a.color;return color;});var bgColor=function(type,theme){if(type===DANGER)return theme.styles.colorDanger;if(type===WARNING)return theme.styles.colorWarning;if(type===SUCCESS)return theme.styles.colorSuccess;return theme.styles.infoPanel.background;};var templateObject_1$1,templateObject_2;var propTypes={exports:{}};var reactIs={exports:{}};var reactIs_production_min={};/** @license React v16.13.1
...
if(phase==='active'){/* eslint-disable no-unused-expressions */node&&node.scrollTop;}if(className){this.appliedClasses[type][phase]=className;_addClass(node,className);}};_proto.removeClasses=function removeClasses(node,type){var _this$appliedClasses$=this.appliedClasses[type],baseClassName=_this$appliedClasses$.base,activeClassName=_this$appliedClasses$.active,doneClassName=_this$appliedClasses$.done;this.appliedClasses[type]={};if(baseClassName){removeClass(node,baseClassName);}if(activeClassName){removeClass(node,activeClassName);}if(doneClassName){removeClass(node,doneClassName);}};_proto.render=function render(){var _this$props=this.props;_this$props.classNames;var props=_objectWithoutPropertiesLoose(_this$props,["classNames"]);return/*#__PURE__*/React__default["default"].createElement(Transition,_extends$7({},props,{onEnter:this.onEnter,onEntered:this.onEntered,onEntering:this.onEntering,onExit:this.onExit,onExiting:this.onExiting,onExited:this.onExited}));};return CSSTransition;}(React__default["default"].Component);CSSTransition.defaultProps={classNames:''};CSSTransition.propTypes=process.env.NODE_ENV!=="production"?_extends$7({},Transition.propTypes,{/**
 ...
 */var generateUID=function(){var counter=1;var map=new WeakMap();/**
     * @borrows {uid}
     */var uid=function(item,index){if(typeof item==='number'||typeof item==='string'){return index?"idx-"+index:"val-"+item;}if(!map.has(item)){map.set(item,counter++);return uid(item);}return'uid'+map.get(item);};return uid;};/**
 * @name uid
 ...
 *
 * @see {@link useUID}
 */var uid=generateUID();var createSource=function(prefix){if(prefix===void 0){prefix='';}return{value:1,prefix:prefix,uid:generateUID()};};var counter=createSource();React__namespace.createContext(createSource());var getId=function(source){return source.value++;};var getPrefix=function(source){return source?source.prefix:'';};// --------------------------------------------
