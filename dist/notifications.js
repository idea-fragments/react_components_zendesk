...
var MIcon__default = /*#__PURE__*/ _interopDefaultLegacy(MIcon)
...
var responsiveStyles = function (_a) {
  ...
  return responsivePropsList === null || responsivePropsList === void 0
    ? void 0
    : responsivePropsList.map(function (_a) {
  ...
  ;(function () {
     ...
     */ var runInContext = function runInContext(context) {
      ...
      /** Used to convert symbols to primitives and strings. */ var symbolProto =
          Symbol ? Symbol.prototype : undefined$1,
...
var Icon = function (_a) {
  var color = _a.color,
    ...
    title = _a.title,
    _c = _a.onClick,
    onClick = _c === void 0 ? DO_NOTHING : _c
  var svgString = svg
  var svgStringList = svg
  var SVGComp = svg
  return isArray(svg)
    ? jsxRuntime.jsx(
        MIcon.Stack,
        __assign(
          ...
          {
            children: svgStringList.map(function (s, i) {
              return jsxRuntime.jsx(MIcon__default["default"], { path: s }, i)
            }),
          },
        ),
      )
    : isString(svg)
    ? jsxRuntime.jsx(MIcon__default["default"], {
        path: svgString,
        size: size,
        title: title,
        color: color || "currentColor",
...
/* MIT license */ var colorNames = colorName$1
...
var cs = (colorString$1.exports = { to: {}, get: {} })
...
/* MIT license */ /* eslint-disable no-mixed-operators */ const cssKeywords =
  colorName // NOTE: conversions should only return primitive values (i.e. arrays, or
...
for (const model of Object.keys(convert)) {
  ...
  const { channels } = convert[model] // Conversion methods
...
var COLORS = {
  ...
  LIGHT_BLUE: "#5293c7",
  BLUE: "#3271A4",
  JAZZ_MAN_BLUE: "#4a5965", // JAZZ_MAN_BLUE      : "#2f3941",
  MIDNIGHT_BLUE: "#2a2b30",
  BLUE_GREEN: "#419eb6", // TEAL             : "#51a9ab",
...
var INFO_PANEL_TYPES = { INFO: 0, SUCCESS: 1, WARNING: 2, DANGER: 3 }
var INFO = INFO_PANEL_TYPES.INFO,
  DANGER = INFO_PANEL_TYPES.DANGER,
  SUCCESS = INFO_PANEL_TYPES.SUCCESS,
  WARNING = INFO_PANEL_TYPES.WARNING
exports.InfoPanel = function (_a) {
  var children = _a.children,
    className = _a.className,
    iconVerticalAlignment = _a.iconVerticalAlignment,
    type = _a.type
  var alignItems = iconVerticalAlignment === "center" ? "center" : undefined
  var theme = useTheme()
  var background = bgColor(type, theme)
  var foreground = theme.styles.getTextColorForBackground({
    color: background,
    theme: theme,
  })
  var iconColor = type === INFO ? COLORS.LIGHT_BLUE : foreground
...
exports.InfoPanel = styled__default["default"](exports.InfoPanel)(
  templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject([""], [""])),
)
exports.InfoPanel.defaultProps = { type: INFO_PANEL_TYPES.INFO }
var Container = styled__default["default"](FlexBox)(
  templateObject_2 ||
...
var bgColor = function (type, theme) {
...
function mergeSymbolMaps(additionalSymbols) {
  ...
  symbolMap.symbols = additionalSymbols
    ? _extends$8({}, defaultSymbolMap.symbols, additionalSymbols.symbols)
    : _extends$8({}, defaultSymbolMap.symbols)
  return symbolMap
}
 ...
 * Based on Underscore.js 1.8.3 <http://underscorejs.org/LICENSE>
 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
 */ /** Used as the `TypeError` message for "Functions" methods. */ var FUNC_ERROR_TEXT =
  "Expected a function"
/** Used to stand-in for `undefined` hash values. */ var HASH_UNDEFINED =
  "__lodash_hash_undefined__"
...
/* Built-in method references that are verified to be native. */ var Map$1 =
    getNative(root, "Map"),
  nativeCreate = getNative(Object, "create")
/**
 * Creates a hash object.
 ...
 */ const PALETTE = {
  ...
  fuschia: { 400: "#d653c2", 600: "#a81897", M400: "#cf62a8", M600: "#a8458c" },
  pink: { 400: "#ec4d63", 600: "#d42054", M400: "#d57287", M600: "#b23a5d" },
  crimson: { 400: "#e34f32", 600: "#c72a1c", M400: "#cc6c5b", M600: "#b24a3c" },
  orange: { 400: "#de701d", 600: "#bf5000", M400: "#d4772c", M600: "#b35827" },
  lemon: { 400: "#ffd424", 600: "#ffbb10", M400: "#e7a500", M600: "#c38f00" },
  lime: { 400: "#43b324", 600: "#2e8200", M400: "#519e2d", M600: "#47782c" },
  mint: { 400: "#00a656", 600: "#058541", M400: "#299c66", M600: "#2e8057" },
  teal: { 400: "#02a191", 600: "#028079", M400: "#2d9e8f", M600: "#3c7873" },
  azure: { 400: "#3091ec", 600: "#1371d6", M400: "#5f8dcf", M600: "#3a70b2" },
  royal: { 400: "#5d7df5", 600: "#3353e2", M400: "#7986d8", M600: "#4b61c3" },
  purple: { 400: "#b552e2", 600: "#6a27b8", M400: "#b072cc", M600: "#9358b0" },
}
const BASE = 4
const borderRadii = { sm: `${BASE / 2}px`, md: `${BASE}px` }
const borderStyles = { solid: "solid" }
const borderWidths = { sm: "1px", md: "3px" }
const borders = {
...
const iconSizes = { sm: "12px", md: "16px", lg: "26px" }
const lineHeights = {
  sm: `${BASE * 4}px`,
  md: `${BASE * 5}px`,
  lg: `${BASE * 6}px`,
...
const shadowWidths = { xs: "1px", sm: "2px", md: "3px" }
const shadows = {
...
const useSelection = (_ref) => {
  ...
  const refs = React.useMemo(
    () =>
      values.reduce((all, value) => {
        all[value] = React.createRef()
        return all
      }, {}),
    [values],
  )
  ...
  const controlledFocusedValue = getControlledValue(
    focusedValue,
    state.focusedValue,
  )
  const controlledSelectedValue = getControlledValue(
    selectedValue,
    state.selectedValue,
  )
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    if (selectedValue === undefined && defaultSelectedValue !== undefined) {
      ...
      if (!isSelectedValueControlled) {
        dispatch({ type: "KEYBOARD_SELECT", payload: defaultSelectedValue })
      }
    }
  }, [])
  const getGroupProps = React.useCallback(function (_temp) {
    let { role = "group", ...other } = _temp === void 0 ? {} : _temp
    return {
  ...
  const getElementProps = (_ref2) => {
    ...
    const handleClick = () => {
      ...
      onFocus && onFocus(value)
      !isSelectedValueControlled &&
        dispatch({ type: "MOUSE_SELECT", payload: value })
    }
    const handleKeyDown = (event) => {
      ...
      if (!hasModifierKeyPressed) {
        if (
          ...
          onSelect && onSelect(value)
          !isSelectedValueControlled &&
            dispatch({ type: "KEYBOARD_SELECT", payload: value })
          event.preventDefault()
        }
      }
    }
...
;({
  children: propTypes.exports.func,
  render: propTypes.exports.func,
  values: propTypes.exports.arrayOf(propTypes.exports.any).isRequired,
  rtl: propTypes.exports.bool,
  direction: propTypes.exports.oneOf(["horizontal", "vertical", "both"]),
  defaultFocusedValue: propTypes.exports.string,
  defaultSelectedValue: propTypes.exports.string,
  focusedValue: propTypes.exports.any,
...
const StyledButtonGroup = styled__default["default"].div
  ...
  [
    "display:inline-flex;position:relative;z-index:0;direction:",
    ";white-space:nowrap;",
    ";",
  ],
  (props) => props.theme.rtl && "rtl",
  (props) => retrieveComponentStyles(COMPONENT_ID$5$1, props),
)
StyledButtonGroup.defaultProps = { theme: DEFAULT_THEME }
...
const sizeStyles$1$1 = (props) => {
  ...
  return (
    marginProperty &&
    styled.css(["", ":", "px;"], marginProperty, props.theme.space.base * 2)
  )
}
const StyledIcon$1 = styled__default["default"]((_ref) => {
  ...
  .withConfig({ displayName: "StyledIcon", componentId: "sc-19meqgg-0" })(
  [
    "transform:",
  ...
  (props) => sizeStyles$1$1(props),
  (props) => retrieveComponentStyles(COMPONENT_ID$4$1, props),
)
StyledIcon$1.defaultProps = { theme: DEFAULT_THEME }
...
const colorStyles$7 = (props) => {
  ...
  if (
    props.disabled ||
    (props.isNeutral &&
      (props.isPrimary || props.isSelected) &&
      !props.isDanger)
  ) {
    hue = "neutralHue"
  ...
  if (props.isLink) {
    retVal = styled.css(
      ...
      focusStyles({
        theme: props.theme,
        condition: false,
        styles: { color: baseColor, outlineColor: focusColor },
      }),
      hoverColor,
      activeColor,
    ...
    retVal = styled.css(
      ...
      props.isPrimary && props.isSelected ? activeColor : baseColor,
      ...
      activeColor,
      props.isPrimary && activeColor,
      disabledBackgroundColor,
      disabledForegroundColor,
    )
  } else {
    const borderColor =
      props.isNeutral && !props.isDanger
    ...
    retVal = styled.css(
      ...
      !props.isBasic && borderColor,
      foregroundColor,
      !props.isBasic && hoverBorderColor,
      rgba(baseColor, 0.08),
      ...
      !props.isBasic && activeColor,
      rgba(baseColor, 0.2),
      !props.isNeutral && activeColor,
      disabledBackgroundColor,
      disabledForegroundColor,
      StyledIcon$1,
      props.isNeutral && getColor("neutralHue", shade, props.theme),
      StyledIcon$1,
      StyledIcon$1,
      StyledIcon$1,
      props.isNeutral && getColor("neutralHue", shade + 100, props.theme),
      StyledIcon$1,
      props.isNeutral && foregroundColor,
      StyledIcon$1,
      disabledForegroundColor,
    )
  }
...
const groupStyles = (props) => {
  ...
  const disabledBackgroundColor =
    !isPrimary && getDisabledBackgroundColor(props)
  ...
  return styled.css(
    [
      ...
      ";box-shadow:",
      ";}&:hover,&:active,",
      "{z-index:1;}&:disabled{z-index:-1;background-color:",
      ";}&:not(:first-of-type){margin-",
      ":",
      ";}&:not(:first-of-type):disabled{margin-",
      ":",
      ";}&:not(:first-of-type):not(:last-of-type){border-radius:0;}&:first-of-type:not(:last-of-type){border-top-",
      "-radius:0;border-bottom-",
      "-radius:0;}&:last-of-type:not(:first-of-type){border-top-",
      "-radius:0;border-bottom-",
      "-radius:0;}&:first-of-type:not(:last-of-type) ",
      "{margin-",
      ":",
...
const iconStyles$1 = (props) => {
  const size =
    props.size === "small" ? props.theme.iconSizes.sm : props.theme.iconSizes.md
  return styled.css(
...
const StyledButton = styled__default["default"].button
  ...
  .withConfig({ displayName: "StyledButton", componentId: "sc-qe3ace-0" })(
  [
    "display:",
    ";align-items:",
    ";justify-content:",
    ";transition:border-color 0.25s ease-in-out,box-shadow 0.1s ease-in-out,background-color 0.25s ease-in-out,color 0.25s ease-in-out,outline-color 0.1s ease-in-out,z-index 0.25s ease-in-out;margin:0;border:",
    ";border-radius:",
    ";cursor:pointer;width:",
    ";overflow:hidden;text-decoration:none;text-overflow:ellipsis;white-space:",
    ";font-family:inherit;font-weight:",
    ";-webkit-font-smoothing:subpixel-antialiased;box-sizing:border-box;user-select:",
    ";-webkit-touch-callout:none;",
    ";&::-moz-focus-inner{border:0;padding:0;}",
    "{text-decoration:none;}&:hover{text-decoration:",
    ";}&:active,&[aria-pressed='true'],&[aria-pressed='mixed']{transition:border-color 0.1s ease-in-out,background-color 0.1s ease-in-out,box-shadow 0.1s ease-in-out,color 0.1s ease-in-out,outline-color 0.1s ease-in-out,z-index 0.25s ease-in-out;text-decoration:",
    ";}",
    ";&:disabled{cursor:default;text-decoration:",
    ";}& ",
    "{",
    "}",
    " &&{",
  ...
  (props) => (props.isLink ? "inline" : "inline-flex"),
  (props) => !props.isLink && "center",
  (props) => !props.isLink && "center",
  (props) =>
    `${props.isLink ? `0px solid` : props.theme.borders.sm} transparent`,
  (props) => getBorderRadius(props),
  (props) => (props.isStretched ? "100%" : ""),
  (props) => !props.isLink && "nowrap",
  (props) => (props.isLink ? "inherit" : props.theme.fontWeights.regular),
  (props) => !props.isLink && "none",
  (props) => sizeStyles$4(props),
  SELECTOR_FOCUS_VISIBLE,
  (props) => (props.isLink ? "underline" : "none"),
  (props) => (props.isLink ? "underline" : "none"),
  (props) => colorStyles$7(props),
  (props) => props.isLink && "none",
  StyledIcon$1,
  (props) => iconStyles$1(props),
  StyledButtonGroup,
  (props) => groupStyles(props),
  (props) => retrieveComponentStyles(COMPONENT_ID$3$1, props),
)
StyledButton.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$2$1 = "buttons.anchor"
const StyledAnchor = styled__default["default"](StyledButton)
  .attrs((props) => ({
  ...
  .withConfig({ displayName: "StyledAnchor", componentId: "sc-xshgmo-0" })(
  ["direction:", ";", ";"],
  (props) => props.theme.rtl && "rtl",
  (props) => retrieveComponentStyles(COMPONENT_ID$2$1, props),
)
StyledAnchor.defaultProps = { theme: DEFAULT_THEME }
var _path$1$1
function _extends$1$1() {
  _extends$1$1 = Object.assign
    ? Object.assign.bind()
    : function (target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i]
...
var SvgNewWindowStroke = function SvgNewWindowStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _path$1$1 ||
      (_path$1$1 = /*#__PURE__*/ React__namespace.createElement("path", {
        fill: "none",
        stroke: "currentColor",
        strokeLinecap: "round",
...
const StyledExternalIcon = styled__default["default"](SvgNewWindowStroke)
  .attrs({
  ...
  [
    "transform:",
    ";margin-bottom:-0.085em;padding-left:0.25em;box-sizing:content-box;width:0.85em;height:0.85em;",
    ";",
  ],
  (props) => props.theme.rtl && "scaleX(-1)",
  (props) => retrieveComponentStyles(COMPONENT_ID$1$1, props),
)
StyledExternalIcon.defaultProps = { theme: DEFAULT_THEME }
...
const iconButtonStyles = (props) => {
  ...
  return styled.css(
    ...
    !props.isPrimary && "transparent",
  )
}
const iconStyles = (props) => {
  const size = props.theme.iconSizes.md
  return styled.css(
    ["width:", ";height:", ";& > svg{transition:opacity 0.15s ease-in-out;}"],
    size,
    size,
  )
}
const StyledIconButton = styled__default["default"](StyledButton)
  .attrs({ "data-garden-id": COMPONENT_ID$c, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledIconButton", componentId: "sc-1t0ughp-0" })(
  ["", ";& ", "{", "}", ";"],
...
StyledIconButton.defaultProps = { theme: DEFAULT_THEME }
...
const StartIconComponent = (props) =>
  React__default["default"].createElement(
    StyledIcon$1,
    _extends$2$1({ position: "start" }, props),
  )
...
const EndIconComponent = (props) =>
  React__default["default"].createElement(
    StyledIcon$1,
    _extends$2$1({ position: "end" }, props),
  )
...
const ButtonComponent = React.forwardRef((props, ref) => {
  ...
  return React__default["default"].createElement(
    StyledButton,
    _extends$2$1({}, computedProps, { ref: computedRef }),
  )
})
ButtonComponent.displayName = "Button"
ButtonComponent.propTypes = {
  isNeutral: propTypes.exports.bool,
  isPrimary: propTypes.exports.bool,
  isDanger: propTypes.exports.bool,
  isPill: propTypes.exports.bool,
  isBasic: propTypes.exports.bool,
  focusInset: propTypes.exports.bool,
  isLink: propTypes.exports.bool,
  isStretched: propTypes.exports.bool,
  isSelected: propTypes.exports.bool,
  size: propTypes.exports.oneOf(SIZE),
}
ButtonComponent.defaultProps = { size: "medium" }
const Button = ButtonComponent
Button.EndIcon = EndIcon
Button.StartIcon = StartIcon
const Anchor = React.forwardRef((_ref, ref) => {
  let { children, isExternal, externalIconLabel, ...otherProps } = _ref
  ...
  return React__default["default"].createElement(
    StyledAnchor,
    _extends$2$1({ ref: ref }, anchorProps),
    children,
    isExternal &&
      React__default["default"].createElement(StyledExternalIcon, {
        role: "img",
...
Anchor.propTypes = {
  isExternal: propTypes.exports.bool,
  isDanger: propTypes.exports.bool,
  externalIconLabel: propTypes.exports.string,
}
const ButtonGroup = React.forwardRef((_ref, ref) => {
  ...
  const { rtl } = React.useContext(styled.ThemeContext) || DEFAULT_THEME
  const [internalSelectedValue, setInternalSelectedValue] = React.useState()
  const selectedValue = getControlledValue(
    controlledSelectedValue,
    internalSelectedValue,
  )
  const values = React.useMemo(
    () =>
      React.Children.toArray(children).reduce((buttons, child) => {
        if (
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      StyledButtonGroup,
      _extends$2$1({ ref: ref }, getGroupProps(otherProps)),
      children,
    ),
  )
})
...
const IconButton = React.forwardRef((_ref, ref) => {
  let { children, isRotated, ...otherProps } = _ref
  const focusInset = useSplitButtonContext()
  return React__default["default"].createElement(
    StyledIconButton,
    _extends$2$1({ ref: ref }, otherProps, {
...
IconButton.propTypes = {
  ...
  isPill: propTypes.exports.bool,
  focusInset: propTypes.exports.bool,
  isRotated: propTypes.exports.bool,
}
IconButton.defaultProps = { isPill: true, isBasic: true, size: "medium" }
var _path$3
function _extends$7() {
...
var SvgChevronDownStroke = function SvgChevronDownStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _path$3 ||
      (_path$3 = /*#__PURE__*/ React__namespace.createElement("path", {
        fill: "currentColor",
...
const ChevronButton = React.forwardRef((_ref, ref) => {
  let { ...buttonProps } = _ref
  return React__default["default"].createElement(
    IconButton,
    _extends$2$1({ ref: ref }, buttonProps),
    React__default["default"].createElement(SvgChevronDownStroke, null),
  )
})
ChevronButton.displayName = "ChevronButton"
ChevronButton.propTypes = IconButton.propTypes
ChevronButton.defaultProps = { isBasic: false, isPill: false, size: "medium" }
const SplitButton = React.forwardRef((_ref, ref) => {
  let { children, ...other } = _ref
  return React__default["default"].createElement(
    SplitButtonContext.Provider,
    { value: true },
    React__default["default"].createElement(
      StyledButtonGroup,
      _extends$2$1({ ref: ref }, other),
      children,
    ),
  )
})
...
const ToggleButton = React.forwardRef((_ref, ref) => {
  let { isPressed, ...otherProps } = _ref
  return React__default["default"].createElement(
    Button,
    _extends$2$1({ "aria-pressed": isPressed, ref: ref }, otherProps),
  )
})
ToggleButton.displayName = "ToggleButton"
ToggleButton.propTypes = {
  ...Button.propTypes,
  isPressed: propTypes.exports.oneOf([true, false, "mixed"]),
}
ToggleButton.defaultProps = { size: "medium" }
...
ToggleIconButton.defaultProps = { isPill: true, isBasic: true, size: "medium" }
 ...
 */ var Transition = /*#__PURE__*/ (function (_React$Component) {
      ...
      if (nextStatus === ENTERING) {
        if (this.props.unmountOnExit || this.props.mountOnEnter) {
          var node = this.props.nodeRef
            ...
            : ReactDOM__default["default"].findDOMNode(this) // https://github.com/reactjs/react-transition-group/pull/749
  ...
  _proto.performEnter = function performEnter(mounting) {
    ...
    var _ref2 = this.props.nodeRef
        ? [appearing]
        : [ReactDOM__default["default"].findDOMNode(this), appearing],
      maybeNode = _ref2[0],
  ...
  _proto.performExit = function performExit() {
    ...
    var maybeNode = this.props.nodeRef
      ? undefined
      : ReactDOM__default["default"].findDOMNode(this) // no exit animation skip right to EXITED
  ...
  _proto.render = function render() {
    ...
    return (
      /*#__PURE__*/ // allows for nested Transitions
      React__default["default"].createElement(
...
Transition.propTypes =
  process.env.NODE_ENV !== "production"
    ? {
          ...
          current:
            typeof Element === "undefined"
              ...
              : function (
                  ...
                  return propTypes.exports.instanceOf(
         ...
         * </Transition>
         * ```
         */ children: propTypes.exports.oneOfType([
          propTypes.exports.func.isRequired,
...
CSSTransition.propTypes =
  process.env.NODE_ENV !== "production"
    ? _extends$8({}, Transition.propTypes, {
        /**
 ...
 */ var ReplaceTransition = /*#__PURE__*/ (function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/ React__default["default"].createElement(
      ...
      props,
      inProp
        ? React__default["default"].cloneElement(first, {
            key: "first",
  ...
  process.env.NODE_ENV !== "production"
    ? {
        ...
        children: function children(props, propName) {
          if (React__default["default"].Children.count(props[propName]) !== 2)
            return new Error(
...
function areChildrenDifferent(oldChildren, newChildren) {
  ...
  if (
    React__default["default"].isValidElement(oldChildren) &&
...
var enterRenders =
  ...
  (_enterRenders[modes.out] = function (_ref3) {
    ...
    return React__default["default"].cloneElement(children, {
      ...
      onEntered: callHook(children, "onEntered", function () {
        changeState(
          ENTERED,
          React__default["default"].cloneElement(children, { in: true }),
        )
      }),
    })
  }),
  (_enterRenders[modes.in] = function (_ref4) {
    ...
    return [
      React__default["default"].cloneElement(current, {
        in: false,
        onExited: callHook(current, "onExited", function () {
          changeState(
            ENTERED,
 ...
 */ var SwitchTransition = /*#__PURE__*/ (function (_React$Component) {
  ...
  function SwitchTransition() {
    ...
    _this.changeState = function (status, current) {
      ...
      _this.setState({ status: status, current: current })
    }
    return _this
  }
...
var createSource = function (prefix) {
  ...
  return { value: 1, prefix: prefix, uid: generateUID() }
}
var counter = createSource()
React__namespace.createContext(createSource())
...
const StyledClose = styled__default["default"].button
  .attrs({ "data-garden-id": COMPONENT_ID$b, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledClose", componentId: "sc-1mr9nx1-0" })(
  [
    "display:block;position:absolute;top:",
    "px;",
    ":",
    ";transition:background-color 0.1s ease-in-out,color 0.25s ease-in-out,box-shadow 0.1s ease-in-out;border:none;border-radius:50%;background-color:transparent;cursor:pointer;padding:0;width:",
    "px;height:",
    "px;overflow:hidden;color:",
    ";font-size:0;user-select:none;&::-moz-focus-inner{border:0;}&:hover{color:",
    ";}",
    " ",
    ";",
  ],
  ...
  (props) => `${props.theme.space.base}px`,
  (props) => props.theme.space.base * 7,
  (props) => props.theme.space.base * 7,
  (props) =>
    props.hue
  ...
  (props) =>
    props.hue
      ? getColor(props.hue, 800, props.theme)
      : getColor("neutralHue", 800, props.theme),
  (props) => focusStyles({ theme: props.theme, inset: true }),
  (props) => retrieveComponentStyles(COMPONENT_ID$b, props),
)
StyledClose.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$a = "notifications.paragraph"
const StyledParagraph = styled__default["default"].p
  .attrs({ "data-garden-id": COMPONENT_ID$a, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledParagraph", componentId: "sc-12tmd6p-0" })(
  ["margin:", "px 0 0;", ";"],
  (props) => props.theme.space.base * 2,
  (props) => retrieveComponentStyles(COMPONENT_ID$a, props),
)
StyledParagraph.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$9 = "notifications.title"
const StyledTitle = styled__default["default"].div
  .attrs({ "data-garden-id": COMPONENT_ID$9, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledTitle", componentId: "sc-xx4jsv-0" })(
...
StyledTitle.defaultProps = { theme: DEFAULT_THEME }
...
const StyledBase = styled__default["default"].div.withConfig({
  ...
  (props) => props.isFloating && boxShadow,
  padding,
  (props) =>
...
StyledBase.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$8 = "notifications.alert"
const colorStyles$5 = (props) =>
  styled.css(
    ["", "{color:", ";}"],
    StyledTitle,
    props.hue && getColor(props.hue, 800, props.theme),
  )
const StyledAlert = styled__default["default"](StyledBase)
  .attrs({ "data-garden-id": COMPONENT_ID$8, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledAlert", componentId: "sc-fyn8jp-0" })(
  ["", " ", ";"],
  colorStyles$5,
  (props) => retrieveComponentStyles(COMPONENT_ID$8, props),
)
StyledAlert.defaultProps = { theme: DEFAULT_THEME }
...
const StyledNotification = styled__default["default"](StyledBase)
  .attrs({ "data-garden-id": COMPONENT_ID$7, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledNotification", componentId: "sc-uf6jh-0" })(
  ["", " ", ";"],
  colorStyles$4,
  (props) => retrieveComponentStyles(COMPONENT_ID$7, props),
)
StyledNotification.propTypes = { type: propTypes.exports.oneOf(TYPE) }
StyledNotification.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$6 = "notifications.well"
const StyledWell = styled__default["default"](StyledBase)
  .attrs({ "data-garden-id": COMPONENT_ID$6, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledWell", componentId: "sc-a5831c-0" })(
  ["background-color:", ";color:", " ", ";"],
  (props) => props.isRecessed && getColor("neutralHue", 100, props.theme),
  (props) => getColor("neutralHue", 600, props.theme),
  (props) => retrieveComponentStyles(COMPONENT_ID$6, props),
)
StyledWell.defaultProps = { theme: DEFAULT_THEME }
...
}).withConfig({ displayName: "StyledIcon", componentId: "sc-msklws-0" })(
  ["position:absolute;right:", ";left:", ";margin-top:", "px;color:", ";"],
  (props) => props.theme.rtl && `${props.theme.space.base * 4}px`,
  (props) => !props.theme.rtl && `${props.theme.space.base * 4}px`,
  (props) => props.theme.space.base / 2,
  (props) =>
    props.hue &&
...
StyledIcon.defaultProps = { theme: DEFAULT_THEME }
...
const sizeStyles$3 = (props) => {
  ...
  return styled.css(
    ["padding:", "px;min-height:", "px;line-height:", ";font-size:", ";"],
    padding,
    minHeight,
    lineHeight,
    fontSizes.md,
...
const StyledGlobalAlert = styled__default["default"].div
  .attrs({ "data-garden-id": COMPONENT_ID$5, "data-garden-version": "8.70.0" })
  .withConfig({ displayName: "StyledGlobalAlert", componentId: "sc-k6rimt-0" })(
  [
  ...
  (props) => (props.theme.rtl ? "rtl" : "ltr"),
  sizeStyles$3,
  colorStyles$3,
  (props) => props.theme.borderRadii.sm,
  (props) => retrieveComponentStyles(COMPONENT_ID$5, props),
)
StyledGlobalAlert.defaultProps = { theme: DEFAULT_THEME }
...
const colorStyles$2 = (props) => {
  ...
  return styled.css(
    [
      "color:inherit;&:hover{background-color:",
      ";color:",
      ";}",
      " &:active{background-color:",
      ";color:",
...
const sizeStyles$2 = (props) => {
  ...
  return styled.css(
    ["margin:", " ", " ", " ", ";"],
    marginVertical,
    props.theme.rtl ? marginStart : marginEnd,
    marginVertical,
    props.theme.rtl ? marginEnd : marginStart,
  )
}
const StyledGlobalAlertClose = styled__default["default"](IconButton)
  .attrs({
  ...
  })(["", ";", ";", ";"], sizeStyles$2, colorStyles$2, (props) =>
  retrieveComponentStyles(COMPONENT_ID$4, props),
)
StyledGlobalAlertClose.defaultProps = { theme: DEFAULT_THEME }
...
function sizeStyles$1(props) {
  ...
  return styled.css(
    ["margin:", " ", " ", " ", ";"],
    marginVertical,
    props.theme.rtl ? marginStart : 0,
    marginVertical,
    props.theme.rtl ? 0 : marginStart,
  )
}
const StyledGlobalAlertButton = styled__default["default"](Button)
  .attrs({
  ...
  })(["flex-shrink:0;", ";", ";", ";"], sizeStyles$1, colorStyles$1, (props) =>
  retrieveComponentStyles(COMPONENT_ID$3, props),
)
StyledGlobalAlertButton.defaultProps = { theme: DEFAULT_THEME }
const COMPONENT_ID$2 = "notifications.global-alert.content"
const StyledGlobalAlertContent = styled__default["default"].div
  .attrs({ "data-garden-id": COMPONENT_ID$2, "data-garden-version": "8.70.0" })
  .withConfig({
    displayName: "StyledGlobalAlertContent",
    componentId: "sc-rept0u-0",
  })(["flex-grow:1;", ";"], (props) =>
  retrieveComponentStyles(COMPONENT_ID$2, props),
)
StyledGlobalAlertContent.defaultProps = { theme: DEFAULT_THEME }
...
const StyledGlobalAlertIcon = styled__default["default"]((_ref) => {
  ...
  .attrs({ "data-garden-id": COMPONENT_ID$1, "data-garden-version": "8.70.0" })
  .withConfig({
    displayName: "StyledGlobalAlertIcon",
    componentId: "sc-84ne9k-0",
  })(["flex-shrink:0;", ";", ";"], sizeStyles, (props) =>
  retrieveComponentStyles(COMPONENT_ID$1, props),
)
StyledGlobalAlertIcon.defaultProps = { theme: DEFAULT_THEME }
...
const StyledGlobalAlertTitle = styled__default["default"].div
  .attrs({ "data-garden-id": COMPONENT_ID, "data-garden-version": "8.70.0" })
  .withConfig({
    displayName: "StyledGlobalAlertTitle",
    componentId: "sc-10clqbo-0",
  })(
  ["display:inline;margin-", ":", "px;font-weight:", ";", ";", ";"],
  (props) => (props.theme.rtl ? "left" : "right"),
  (props) => props.theme.space.base * 2,
  (props) =>
    props.isRegular
...
StyledGlobalAlertTitle.defaultProps = { theme: DEFAULT_THEME }
var _g$2, _circle$2
function _extends$5() {
...
var SvgAlertErrorStroke = function SvgAlertErrorStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _g$2 ||
      (_g$2 = /*#__PURE__*/ React__namespace.createElement(
        "g",
    ...
    _circle$2 ||
      (_circle$2 = /*#__PURE__*/ React__namespace.createElement("circle", {
        cx: 7.5,
        cy: 12,
        r: 1,
        fill: "currentColor",
...
var SvgCheckCircleStroke = function SvgCheckCircleStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _g$1 ||
      (_g$1 = /*#__PURE__*/ React__namespace.createElement(
        "g",
        { fill: "none", stroke: "currentColor" },
        /*#__PURE__*/ React__namespace.createElement("path", {
          strokeLinecap: "round",
...
var SvgAlertWarningStroke = function SvgAlertWarningStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _circle$1 ||
      (_circle$1 = /*#__PURE__*/ React__namespace.createElement("circle", {
        cx: 7.5,
        cy: 12,
        r: 1,
        fill: "currentColor",
...
var SvgInfoStroke = function SvgInfoStroke(props) {
  return /*#__PURE__*/ React__namespace.createElement(
    ...
    _g ||
      (_g = /*#__PURE__*/ React__namespace.createElement(
        "g",
        { stroke: "currentColor" },
        /*#__PURE__*/ React__namespace.createElement("circle", {
          cx: 7.5,
...
const Alert = React__default["default"].forwardRef((_ref, ref) => {
  let { role, ...props } = _ref
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      StyledAlert,
      _extends$6(
        { ref: ref, hue: hue, role: role === undefined ? "alert" : role },
        props,
      ),
      React__default["default"].createElement(
        StyledIcon,
...
Alert.propTypes = { type: propTypes.exports.oneOf(TYPE).isRequired }
const Notification$1 = React.forwardRef((_ref, ref) => {
  let { role, ...props } = _ref
  const Icon = props.type ? validationIcons[props.type] : SvgInfoStroke
  const hue = props.type && validationHues[props.type]
  return React__default["default"].createElement(
    StyledNotification,
    _extends$6({ ref: ref, type: props.type, isFloating: true }, props, {
...
Notification$1.propTypes = { type: propTypes.exports.oneOf(TYPE) }
const Well = React__default["default"].forwardRef((props, ref) =>
  React__default["default"].createElement(
    StyledWell,
    _extends$6({ ref: ref }, props),
  ),
)
Well.displayName = "Well"
Well.propTypes = {
  isRecessed: propTypes.exports.bool,
  isFloating: propTypes.exports.bool,
}
var _path$1
function _extends$1() {
...
const Close = React__default["default"].forwardRef((props, ref) => {
  ...
  return React__default["default"].createElement(
    StyledClose,
    _extends$6({ ref: ref, hue: hue, "aria-label": ariaLabel }, props),
    React__default["default"].createElement(SvgXStroke$1, null),
  )
})
Close.displayName = "Close"
const Paragraph = React__default["default"].forwardRef((props, ref) =>
  React__default["default"].createElement(
    StyledParagraph,
    _extends$6({ ref: ref }, props),
  ),
...
const Title = React__default["default"].forwardRef((props, ref) =>
  React__default["default"].createElement(
    StyledTitle,
    _extends$6({ ref: ref }, props),
  ),
  ...
  switch (action.type) {
    ...
    case "UPDATE_TOAST": {
      const updatedToasts = state.toasts.map((toast) => {
        ...
        updatedToast.options = { ...updatedToast.options, ...newOptions }
        return updatedToast
      })
...
const DEFAULT_TOAST_OPTIONS = { autoDismiss: 5000, placement: "top-end" }
const useToast = () => {
...
const Toast = (_ref) => {
  ...
  React.useEffect(() => {
    if (pauseTimers && !isNaN(remainingTime)) {
      previousRemainingTimeRef.current =
        remainingTime - (Date.now() - startTimeRef.current)
      setRemainingTime(NaN)
    } else if (
      !pauseTimers &&
      isNaN(remainingTime) &&
      !isNaN(previousRemainingTimeRef.current)
    ) {
...
const StyledFadeInTransition = styled__default["default"].div.withConfig({
  ...
  [
    "transition:opacity ",
    " ease-in 300ms;opacity:",
    ";margin-bottom:",
    "px;",
    " &.",
    "-enter{transform:translateY( ",
    " );opacity:0;max-height:0;}&.",
    "-enter-active{transform:translateY(0);transition:opacity ",
    " ease-in,transform ",
    " cubic-bezier(0.15,0.85,0.35,1.2),max-height ",
    ";opacity:1;max-height:500px;}&.",
    "-exit{opacity:1;max-height:500px;}&.",
    "-exit-active{transition:opacity 550ms ease-out,max-height ",
    " linear 150ms;opacity:0;max-height:0;}",
  ],
  DEFAULT_DURATION,
  (p) => (p.isHidden ? "0 !important" : 1),
  (p) => p.theme.space.base * 2,
...
StyledFadeInTransition.defaultProps = { theme: DEFAULT_THEME }
const placementStyles = (props) => {
  ...
  const topLeftStyles = styled.css(
    ["top:", ";left:", ";"],
    verticalDistance,
    horizontalDistance,
  )
  const topStyles = styled.css(
  ...
  const bottomLeftStyles = styled.css(
    ["bottom:", ";left:", ";"],
    verticalDistance,
    horizontalDistance,
  )
  const bottomStyles = styled.css(
    ["bottom:", ";left:50%;transform:translate(-50%,0);"],
    verticalDistance,
  )
  const bottomRightStyles = styled.css(
    ["right:", ";bottom:", ";"],
    horizontalDistance,
    verticalDistance,
  )
...
const StyledTransitionContainer = styled__default["default"].div.withConfig({
  ...
  (props) => props.toastZIndex,
  placementStyles,
)
StyledTransitionContainer.defaultProps = { theme: DEFAULT_THEME }
...
const ToastProvider$1 = (_ref) => {
  let { limit, zIndex, placementProps = {}, children } = _ref
  const [state, dispatch] = React.useReducer(toasterReducer, getInitialState())
  const contextValue = React.useMemo(
    () => ({ state, dispatch }),
    [state, dispatch],
  )
  const toastsByPlacement = React.useCallback(
    (placement) => {
...
ToastProvider$1.displayName = "ToastProvider"
ToastProvider$1.defaultProps = { limit: 4 }
ToastProvider$1.propTypes = {
  limit: propTypes.exports.number,
  zIndex: propTypes.exports.number,
  placementProps: propTypes.exports.object,
}
const GlobalAlertContext = React.createContext({ type: "info" })
const useGlobalAlertContext = () => React.useContext(GlobalAlertContext)
const GlobalAlertButton = React.forwardRef((_ref, ref) => {
  let { isBasic, ...props } = _ref
  const { type } = useGlobalAlertContext()
  return React__default["default"].createElement(
    StyledGlobalAlertButton,
    _extends$6({ ref: ref, alertType: type }, props, {
      isPrimary: !isBasic,
      isBasic: isBasic,
    }),
  )
...
GlobalAlertButton.propTypes = { isBasic: propTypes.exports.bool }
var _path
function _extends() {
...
const GlobalAlertClose = React.forwardRef((props, ref) => {
  ...
  return React__default["default"].createElement(
    ...
    _extends$6({ ref: ref, alertType: type }, props),
    React__default["default"].createElement(SvgXStroke, {
      role: "img",
      "aria-label": label,
    }),
  )
...
const GlobalAlertTitle = React.forwardRef((props, ref) => {
  ...
  return React__default["default"].createElement(
    ...
    _extends$6({ alertType: type, ref: ref }, props),
  )
})
GlobalAlertTitle.displayName = "GlobalAlert.Title"
GlobalAlertTitle.propTypes = { isRegular: propTypes.exports.bool }
const GlobalAlertComponent = React.forwardRef((_ref, ref) => {
  let { type, ...props } = _ref
  return React__default["default"].createElement(
    GlobalAlertContext.Provider,
    { value: React.useMemo(() => ({ type }), [type]) },
    React__default["default"].createElement(
      StyledGlobalAlert,
      _extends$6({ ref: ref, role: "status", alertType: type }, props),
      {
        success: React__default["default"].createElement(
          StyledGlobalAlertIcon,
          null,
          React__default["default"].createElement(SvgCheckCircleStroke, null),
        ),
        error: React__default["default"].createElement(
          StyledGlobalAlertIcon,
          null,
          React__default["default"].createElement(SvgAlertErrorStroke, null),
        ),
        warning: React__default["default"].createElement(
          StyledGlobalAlertIcon,
          null,
          React__default["default"].createElement(SvgAlertWarningStroke, null),
        ),
        info: React__default["default"].createElement(
          StyledGlobalAlertIcon,
          null,
          React__default["default"].createElement(SvgInfoStroke, null),
        ),
      }[type],
      props.children,
    ),
...
const GlobalAlert$1 = GlobalAlertComponent
GlobalAlert$1.Button = GlobalAlertButton
GlobalAlert$1.Close = GlobalAlertClose
GlobalAlert$1.Content = GlobalAlertContent
GlobalAlert$1.Title = GlobalAlertTitle
GlobalAlert$1.propTypes = { type: propTypes.exports.oneOf(TYPE).isRequired }
var Notification = function (_a) {
  var body = _a.body,
    danger = _a.danger,
    info = _a.info,
    notDismissible = _a.notDismissible,
    success = _a.success,
    title = _a.title,
    warning = _a.warning,
    _b = _a.onClose,
    onClose = _b === void 0 ? DO_NOTHING : _b
  var dismissible = !notDismissible
  var type = function () {
  ...
  return jsxRuntime.jsxs(
    ...
    __assign(
      ...
      {
        children: [
          jsxRuntime.jsx(Title, { children: title }),
          jsxRuntime.jsx("div", { children: body }),
          dismissible
            ? jsxRuntime.jsx(Close, {
                onClick: onClose,
...
var ToastProvider = styled__default["default"](ToastProvider$1).attrs({
  zIndex: 1000,
})(templateObject_1 || (templateObject_1 = __makeTemplateObject([""], [""])))
var templateObject_1
var useToastNotifier = function () {
  var addToast = useToast().addToast
  var notify = React.useCallback(
    function (p) {
      addToast(function (_a) {
        var close = _a.close
        return jsxRuntime.jsx(Notification, __assign({}, p, { onClose: close }))
      })
    },
    [addToast],
  )
...
var GlobalAlert = function (_a) {
  var body = _a.body,
    danger = _a.danger
  _a.info
  var notDismissible = _a.notDismissible,
    noActionButton = _a.noActionButton,
    _b = _a.showTitle,
    ...
    warning = _a.warning,
    _c = _a.onActionButtonClick,
    onActionButtonClick = _c === void 0 ? DO_NOTHING : _c,
    _d = _a.onClose,
    onClose = _d === void 0 ? DO_NOTHING : _d
  var dismissible = !notDismissible
  var hasActionButton = !noActionButton
  var type = function () {
    if (danger) return "error"
    if (success) return "success"
    if (warning) return "warning"
  ...
  return jsxRuntime.jsxs(
    ...
    __assign(
      ...
      {
        children: [
          jsxRuntime.jsxs(GlobalAlert$1.Content, {
            children: [
              showTitle
                ? jsxRuntime.jsx(GlobalAlert$1.Title, { children: title })
                : null,
              jsxRuntime.jsx("div", { children: body }),
            ],
          }),
          hasActionButton
            ...
            : null,
          dismissible
            ? jsxRuntime.jsx(GlobalAlert$1.Close, {
                onClick: onClose,
...
exports.INFO_PANEL_TYPES = INFO_PANEL_TYPES
exports.Notification = Notification
exports.ToastProvider = ToastProvider
exports.useToastNotifier = useToastNotifier
