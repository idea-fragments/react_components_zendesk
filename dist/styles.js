...
var fade = function (c, amount) {
    ...
    var _a = color(c).fade(amount).object(), r = _a.r, g = _a.g, b = _a.b, alpha = _a.alpha;
    return "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", ").concat(alpha, ")");
};
var light$1 = function (c, amount) {
    if (amount === void 0) { amount = 0.15; }
    return color(c).lighten(amount).hex();
};
var lighter = function (c) { return light$1(c, 0.25); };
var veryLight = function (c) { return light$1(c, 0.7); };
var dark$1 = function (c, amount) {
    if (amount === void 0) { amount = 0.2; }
    return (color(c).darken(amount).hex());
};
var darker = function (c) { return dark$1(c, 0.3); };
var veryDark = function (c) { return dark$1(c, 0.4); };
var desaturate = function (c) { return color(c).desaturate(0.25).hex(); };
var saturate = function (c) { return color(c).saturate(0.25).hex(); };
...
var dark = {
    ...
    styles: __assign(__assign({}, base), { 
        // deprecated
        // @ts-ignore
        navBackground: "#1d1e21", nav: {
            linkColor: light$1(COLORS.GREY),
        }, footer: {
            background: lighter(COLORS.MIDNIGHT_BLUE),
        }, overlayBackground: fade(COLORS.LIGHT_GREY, .9), pageBackground: COLORS.MIDNIGHT_BLUE, scrollbar: {
            thumbColor: "#ffffff55",
            trackColor: "#ffffff33",
        }, sidebar: __assign(__assign({}, base.sidebar), { background: COLORS.MIDNIGHT_BLUE }), textColorDark: COLORS.MIDNIGHT_PURPLE, textColorLight: textColorPrimary$2, textColorOverPrimaryBg: COLORS.WHITE, textColorPrimary: textColorPrimary$2, textColorSecondary: COLORS.GREY_NOT_QUITE_BLUE }),
};

var textColorPrimary$1 = COLORS.JAZZ_MAN_BLUE;
var light = {
    isDark: false,
    styles: __assign(__assign({}, base), { appBar: __assign(__assign({}, base.appBar), { background: "transparent" }), 
        // deprecated
        // @ts-ignore
        navBackground: COLORS.GREY_NOT_QUITE_BLUE, nav: {
            linkColor: COLORS.MIDNIGHT_PURPLE,
        }, footer: {
            background: COLORS.MIDNIGHT_BLUE,
        }, infoPanel: {
            background: COLORS.VERY_LIGHT_GREY,
        }, pageBackground: COLORS.WHITE, overlayBackground: fade(COLORS.LIGHT_GREY), scrollbar: {
            thumbColor: "#00000033",
            trackColor: "#00000022",
        }, sidebar: __assign(__assign({}, base.sidebar), { background: COLORS.WHITE }), textColorDark: textColorPrimary$1, textColorLight: COLORS.WHITE, textColorOverPrimaryBg: COLORS.WHITE, textColorPrimary: textColorPrimary$1, textColorSecondary: COLORS.GREY_NOT_QUITE_BLUE }),
};
...
light2.styles = __assign(__assign({}, light2.styles), { appBar: __assign(__assign({}, light2.styles.appBar), { shadow: "#0000000d 0 0 15px 0" }), pageBackground: "#f7f7f7", section: __assign(__assign({}, light2.styles.section), { background: "#fff", borderRadius: "3px", margin: "".concat(SPACINGS.XXXL, " 0"), padding: "2rem", shadow: "#00000014 0 6px 14px 0" }) });
...
var backgroundPrimaryWithText = css(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n  background: ", ";\n  color: ", ";\n"], ["\n  background: ", ";\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.styles.colorPrimary;
}, function (_a) {
    var theme = _a.theme;
    var _b = theme.styles, getTextColorForBackground = _b.getTextColorForBackground, colorPrimary = _b.colorPrimary;
    return getTextColorForBackground({ color: colorPrimary, theme: theme });
});
var textColorForBackground = css(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.styles.getTextColorForBackground(props); });
var textColorPrimary = css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.styles.textColorPrimary;
});
var textWithColor = css(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var color = _a.color;
...
var deviseSizes = function (wideLayout) {
    if (wideLayout === void 0) { wideLayout = false; }
    return wideLayout ? WIDE_SIZES : REGULAR_SIZES;
};

var PHONE_SIZE = 560;
var TABLET_SIZE = 840;
var forPhones = function (styles) { return "\n    @media screen and (max-width: ".concat(unit(PHONE_SIZE), ") {\n        ").concat(styles, "\n    }\n"); };
var forTablets = function (styles) { return "\n    @media screen and (max-width: ".concat(unit(TABLET_SIZE), ") {\n        ").concat(styles, "\n    }\n"); };
var mediaQueries = function (wideLayout) {
    var _a = deviseSizes(wideLayout), phoneSize = _a.phoneSize, tabletSize = _a.tabletSize, largeTabletSize = _a.largeTabletSize, smallComputerSize = _a.smallComputerSize;
    return {
        forPhones: function (styles) { return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      @media screen and (max-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media screen and (max-width: ", ") {\n        ", "\n      }\n    "])), unit(phoneSize), styles); },
        forTablets: function (styles) { return css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      @media screen and (max-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media screen and (max-width: ", ") {\n        ", "\n      }\n    "])), unit(tabletSize), styles); },
        forTabletsAndUp: function (styles) { return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "])), unit(phoneSize + 1), styles); },
        forLargeTabletsAndUp: function (styles) { return css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      @media (min-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media (min-width: ", ") {\n        ", "\n      }\n    "])), unit(tabletSize + 1), styles); },
        forSmallComputersAndUp: function (styles) { return css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "])), unit(largeTabletSize + 1), styles); },
        forLargeComputers: function (styles) { return css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "], ["\n      @media screen and (min-width: ", ") {\n        ", "\n      }\n    "])), unit(smallComputerSize + 1), styles); },
    };
};
var rem = function (px) { return "".concat(px / remSize(), "rem"); };
var unit = function (px) { return "".concat(px, "px"); };
...
var deviceQueries = function (isSkinnyLayout) {
    var _a;
    var _b = deviseSizes(!isSkinnyLayout), phoneSize = _b.phoneSize, tabletSize = _b.tabletSize, largeTabletSize = _b.largeTabletSize, smallComputerSize = _b.smallComputerSize;
    return _a = {},
        _a[DEVICES.phone] = "(max-width: ".concat(unit(phoneSize), ")"),
        _a[DEVICES.tablet] = "(min-width: ".concat(unit(phoneSize + 1), ") and (max-width: ").concat(unit(tabletSize), ")"),
        _a[DEVICES.largeTablet] = "(min-width: ".concat(unit(tabletSize + 1), ") and (max-width: ").concat(unit(largeTabletSize), ")"),
        _a[DEVICES.smallComputer] = "(min-width: ".concat(unit(largeTabletSize + 1), ") and (max-width: ").concat(unit(smallComputerSize), ")"),
        _a[DEVICES.largeComputer] = "(min-width: ".concat(unit(smallComputerSize + 1), ")"),
        _a;
};
var logger = new Logger("DeviceSizeWatcher");
var checkAny = function (arr) { return function () { return arr.some(function (f) { return f(); }); }; };
var DeviceSizeWatcher = /** @class */ (function () {
    function DeviceSizeWatcher() {
        ...
        this.notifyReceivers = function (s) {
            Object.values(_this.subscribers)
                .forEach(function (f) { !!f && f(s); });
        };
        this.isPhone = function () { return _this.currentSize === DEVICES.phone; };
        this.isTablet = function () { return _this.currentSize === DEVICES.tablet; };
        this.isLargeTablet = function () { return _this.currentSize === DEVICES.largeTablet; };
        this.isSmallComputer = function () { return _this.currentSize === DEVICES.smallComputer; };
        this.isLargeComputer = function () { return _this.currentSize === DEVICES.largeComputer; };
        this.isSmallComputerAndUp = checkAny([
            this.isSmallComputer,
            this.isLargeComputer,
        ]);
        this.isLargeTabletAndUp = checkAny([
            this.isLargeTablet,
            this.isSmallComputerAndUp,
        ]);
        this.isTabletAndUp = checkAny([this.isTablet, this.isLargeTabletAndUp]);
        this.any = function (arr) { return arr.some(function (f) { return f(); }); };
        this.getSize = function () { return _this.currentSize; };
        this.createAllListeners = function () {
            ...
            Object.entries(DEVICES)
                .forEach(function (_a) {
                var _b = __read(_a, 2), name = _b[0], s = _b[1];
...
const THEMES = { light, light2, dark };
