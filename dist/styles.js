...
for (var name in colorNames) {
  if (hasOwnProperty$b.call(colorNames, name)) {
...
cs.get.rgb = function (string) {
  ...
  if ((match = string.match(hex))) {
    ...
    if (!hasOwnProperty$b.call(colorNames, match[1])) {
      return null
    }
...
function isFunction$3(value) {
  ...
  return (
    tag == funcTag$3 || tag == genTag$2 || tag == asyncTag || tag == proxyTag
  )
}
...
var Map$5 = getNative$7(root$6, "Map")
var _Map = Map$5
...
function assignValue$2(object, key, value) {
  ...
  if (
    !(hasOwnProperty$6.call(object, key) && eq$1(objValue, value)) ||
...
if (
  ...
  (Map$2 && getTag$3(new Map$2()) != mapTag$3) ||
...
var backgroundPrimaryWithText = styledComponents.css(
  templateObject_1$1 ||
...
var textColorForBackground = styledComponents.css(
  templateObject_2$1 ||
...
var textColorPrimary = styledComponents.css(
  templateObject_3$1 ||
...
var textWithColor = styledComponents.css(
  templateObject_4$1 ||
...
var forPhones = function (styles) {
  return "\n    @media screen and (max-width: "
    .concat(unit(PHONE_SIZE), ") {\n        ")
    .concat(styles, "\n    }\n")
}
var forTablets = function (styles) {
  return "\n    @media screen and (max-width: "
    .concat(unit(TABLET_SIZE), ") {\n        ")
    .concat(styles, "\n    }\n")
}
...
var remSize = function (e) {
  ...
  return Number(
    window.getComputedStyle(e, null).fontSize.replace(/[A-Za-z]/g, ""),
  )
}
