...
`
styled__default["default"](Paragraph)`
...
var light = function (c, amount) {
  ...
  var newColor = color(c).lighten(amount).hex()
...
const StyledAvatar = styled__default["default"]((_ref) => {
  ...
  })(["flex-shrink:0;font-size:0;", ";"], (props) =>
...
const StyledClose = styled__default["default"].button
  ...
  [
    "display:flex;flex-shrink:0;align-items:center;justify-content:center;transition:opacity 0.25s ease-in-out;opacity:0.8;border:0;background:transparent;cursor:pointer;padding:0;color:inherit;font-size:0;appearance:none;&:hover{opacity:0.9;}&:focus{outline:none;}",
    ";",
  ],
...
const sizeStyles = (props) => {
  ...
  let avatarBorderRadius =
    props.size === "large" ? math(`${borderRadius} - 1`) : borderRadius
  ...
  return styled.css(
    ...
    borderRadius,
    padding,
    minWidth ? `${minWidth}px` : `calc(${padding * 2}px + 1ch)`,
    height,
    getLineHeight(height, fontSize),
    fontSize,
    minWidth ? `${minWidth - padding * 2}px` : "1ch",
    StyledAvatar,
...
const StyledTag = styled__default["default"].div
  ...
  [
    "display:inline-flex;flex-wrap:nowrap;align-items:center;justify-content:",
    ";transition:box-shadow 0.1s ease-in-out;box-sizing:border-box;border:0;max-width:100%;overflow:hidden;vertical-align:middle;text-decoration:none;white-space:nowrap;font-weight:",
    ";direction:",
    ";",
    ";&:hover{cursor:default;text-decoration:none;}&:link:hover,&:visited:hover{cursor:pointer;}&:any-link:hover{cursor:pointer;}",
    "{text-decoration:none;}",
    ";& > *{overflow:hidden;text-align:center;text-overflow:ellipsis;white-space:nowrap;}& b{font-weight:",
    ";}& ",
    "{display:",
    ";}& ",
    "{display:",
  ...
  (props) => props.isRound && "center",
  (props) => !props.isRegular && props.theme.fontWeights.semibold,
  ...
  StyledAvatar,
  (props) => (props.isRound || props.size === "small") && "none",
  StyledClose,
  (props) => props.isRound && "none",
...
const AvatarComponent = (props) =>
  React__default["default"].createElement(StyledAvatar, props)
...
TagComponent.propTypes = {
  ...
  hue: propTypes.exports.string,
  isPill: propTypes.exports.bool,
  isRound: propTypes.exports.bool,
  isRegular: propTypes.exports.bool,
}
...
var Close = styled__default["default"](Tag.Close)(
...
exports.Tag = React.forwardRef(function (_a, ref) {
  ...
  var onCloseClicked = React.useCallback(
    function (e) {
      e.preventDefault()
      e.stopPropagation()
      onClose()
...
exports.Tag = styled__default["default"](exports.Tag)(
  templateObject_2 ||
