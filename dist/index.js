...
var TestComponent = function () {
    var _a = __read(require$$0.useState(32), 2), a = _a[0]; _a[1];
    console.log("theme", a);
    return jsxRuntime.exports.jsx("button", { children: "TestComponent" });
};
var AnotherComponent = function () {
    return jsxRuntime.exports.jsx("button", { children: "AnotherComponent" });
};
